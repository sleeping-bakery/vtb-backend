...
/// </summary>
[DataContract(Name = "PartyIdentificationComplexType")]
public class PartyIdentificationComplexType : IEquatable<PartyIdentificationComplexType>, IValidatableObject
{
    /// <summary>
    ///     Initializes a new instance of the <see cref="PartyIdentificationComplexType" /> class.
    /// </summary>
    [JsonConstructorAttribute]
    protected PartyIdentificationComplexType()
    {
    }
    ...
    public PartyIdentificationComplexType(string inn = default, string name = default, string kpp = default)
    {
        // to ensure "inn" is required (not null)
        if (inn == null) throw new ArgumentNullException("inn is a required property for PartyIdentificationComplexType and cannot be null");
        Inn = inn;
        Name = name;
        Kpp = kpp;
    }
    ...
    /// <summary>
    ///     Returns true if PartyIdentificationComplexType instances are equal
    /// </summary>
    /// <param name="input">Instance of PartyIdentificationComplexType to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(PartyIdentificationComplexType input)
    {
    ...
    public override string ToString()
    {
        ...
        sb.Append("class PartyIdentificationComplexType {\n");
    ...
    {
        return Equals(input as PartyIdentificationComplexType);
    }
