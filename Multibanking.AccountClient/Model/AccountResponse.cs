...
public class AccountResponse : IEquatable<AccountResponse>, IValidatableObject
{
    ...
    public AccountResponse(DataAccountResponseComplexType data = default, object risk = default,
        LinksType links = default, MetaType meta = default)
    {
        ...
        if (risk == null)
            throw new ArgumentNullException("risk is a required property for AccountResponse and cannot be null");
        Risk = risk;
        // to ensure "links" is required (not null)
        if (links == null)
            throw new ArgumentNullException("links is a required property for AccountResponse and cannot be null");
        Links = links;
        // to ensure "meta" is required (not null)
        if (meta == null)
            throw new ArgumentNullException("meta is a required property for AccountResponse and cannot be null");
        Meta = meta;
    }
