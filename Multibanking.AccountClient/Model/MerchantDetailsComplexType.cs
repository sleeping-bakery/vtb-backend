...
/// </summary>
[DataContract(Name = "MerchantDetailsComplexType")]
public class MerchantDetailsComplexType : IEquatable<MerchantDetailsComplexType>, IValidatableObject
{
    /// <summary>
    ///     Initializes a new instance of the <see cref="MerchantDetailsComplexType" /> class.
    /// </summary>
    ...
    public MerchantDetailsComplexType(string merchantName = default, string merchantCategoryCode = default)
    {
    ...
    /// <summary>
    ///     Returns true if MerchantDetailsComplexType instances are equal
    /// </summary>
    /// <param name="input">Instance of MerchantDetailsComplexType to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(MerchantDetailsComplexType input)
    {
    ...
    public override string ToString()
    {
        ...
        sb.Append("class MerchantDetailsComplexType {\n");
    ...
    {
        return Equals(input as MerchantDetailsComplexType);
    }
