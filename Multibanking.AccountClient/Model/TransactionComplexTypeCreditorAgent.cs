...
public class TransactionComplexTypeCreditorAgent : IEquatable<TransactionComplexTypeCreditorAgent>, IValidatableObject
{
    /// <summary>
    ...
    public TransactionComplexTypeCreditorAgent(FinancialInstitutionIdentificationDynamicType? schemeName = default, string identification = default, string name = default,
