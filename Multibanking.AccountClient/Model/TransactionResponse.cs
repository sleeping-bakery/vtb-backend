...
public class TransactionResponse : IEquatable<TransactionResponse>, IValidatableObject
{
    ...
    public TransactionResponse(DataTransactionResponseComplexType data = default, object risk = default,
        LinksType links = default, MetaType meta = default)
    {
        // to ensure "data" is required (not null)
        if (data == null)
            throw new ArgumentNullException("data is a required property for TransactionResponse and cannot be null");
        Data = data;
        // to ensure "risk" is required (not null)
        if (risk == null)
            throw new ArgumentNullException("risk is a required property for TransactionResponse and cannot be null");
        Risk = risk;
        // to ensure "links" is required (not null)
        if (links == null)
            throw new ArgumentNullException("links is a required property for TransactionResponse and cannot be null");
        Links = links;
        // to ensure "meta" is required (not null)
        if (meta == null)
            throw new ArgumentNullException("meta is a required property for TransactionResponse and cannot be null");
        Meta = meta;
    }
