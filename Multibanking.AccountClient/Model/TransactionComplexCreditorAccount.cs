...
public class TransactionComplexCreditorAccount : IEquatable<TransactionComplexCreditorAccount>, IValidatableObject
{
    ...
    /// <summary>
    ///     Returns true if TransactionComplexCreditorAccount instances are equal
    /// </summary>
    /// <param name="input">Instance of TransactionComplexCreditorAccount to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(TransactionComplexCreditorAccount input)
    {
    ...
    public override string ToString()
    {
        ...
        sb.Append("class TransactionComplexCreditorAccount {\n");
    ...
    {
        return Equals(input as TransactionComplexCreditorAccount);
    }
