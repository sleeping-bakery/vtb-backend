...
public class CurrencyExchangeComplexTypeInstructedAmount : IEquatable<CurrencyExchangeComplexTypeInstructedAmount>, IValidatableObject
{
    ...
    protected CurrencyExchangeComplexTypeInstructedAmount()
    {
    }
    ...
    /// <summary>
    ///     Returns true if CurrencyExchangeComplexTypeInstructedAmount instances are equal
    /// </summary>
    /// <param name="input">Instance of CurrencyExchangeComplexTypeInstructedAmount to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(CurrencyExchangeComplexTypeInstructedAmount input)
    {
    ...
    public override string ToString()
    {
        ...
        sb.Append("class CurrencyExchangeComplexTypeInstructedAmount {\n");
    ...
    {
        return Equals(input as CurrencyExchangeComplexTypeInstructedAmount);
    }
