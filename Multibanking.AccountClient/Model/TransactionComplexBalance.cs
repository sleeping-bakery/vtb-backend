...
/// <summary>
///     Детальная информация о балансе счета
/// </summary>
[DataContract(Name = "TransactionComplex_Balance")]
public class TransactionComplexBalance : IEquatable<TransactionComplexBalance>, IValidatableObject
{
    /// <summary>
    ///     Initializes a new instance of the <see cref="TransactionComplexBalance" /> class.
    /// </summary>
    [JsonConstructorAttribute]
    protected TransactionComplexBalance()
    {
    }
    ...
    /// <summary>
    ///     Returns true if TransactionComplexBalance instances are equal
    /// </summary>
    /// <param name="input">Instance of TransactionComplexBalance to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(TransactionComplexBalance input)
    {
    ...
    public override string ToString()
    {
        ...
        sb.Append("class TransactionComplexBalance {\n");
    ...
    {
        return Equals(input as TransactionComplexBalance);
    }
