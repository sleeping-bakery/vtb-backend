...
/// </summary>
[DataContract(Name = "RetrievalGrantResponse")]
public class RetrievalGrantResponse : IEquatable<RetrievalGrantResponse>, IValidatableObject
{
    /// <summary>
    ///     Initializes a new instance of the <see cref="RetrievalGrantResponse" /> class.
    /// </summary>
    [JsonConstructorAttribute]
    protected RetrievalGrantResponse()
    {
    }
    ...
    /// <summary>
    ///     Returns true if RetrievalGrantResponse instances are equal
    /// </summary>
    /// <param name="input">Instance of RetrievalGrantResponse to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(RetrievalGrantResponse input)
    {
    ...
    public override string ToString()
    {
        ...
        sb.Append("class RetrievalGrantResponse {\n");
    ...
    {
        return Equals(input as RetrievalGrantResponse);
    }
