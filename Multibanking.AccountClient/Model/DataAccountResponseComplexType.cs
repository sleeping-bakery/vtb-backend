...
/// </summary>
[DataContract(Name = "DataAccountResponseComplexType")]
public class DataAccountResponseComplexType : IEquatable<DataAccountResponseComplexType>, IValidatableObject
{
    /// <summary>
    ...
    /// </summary>
    /// <param name="input">Instance of DataAccountResponseComplexType to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(DataAccountResponseComplexType input)
    {
        ...
        return
            ...
            (Account != null &&
             input.Account != null &&
             Account.SequenceEqual(input.Account));
    }
    ...
    public override string ToString()
    {
        ...
        sb.Append("class DataAccountResponseComplexType {\n");
    ...
    {
        return Equals(input as DataAccountResponseComplexType);
    }
