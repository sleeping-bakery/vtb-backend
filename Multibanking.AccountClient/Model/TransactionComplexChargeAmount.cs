    ...
    public TransactionComplexChargeAmount(string amount = default, string currency = default)
    {
        ...
        if (amount == null)
            throw new ArgumentNullException(
                "amount is a required property for TransactionComplexChargeAmount and cannot be null");
        Amount = amount;
        // to ensure "currency" is required (not null)
        if (currency == null)
            throw new ArgumentNullException(
                "currency is a required property for TransactionComplexChargeAmount and cannot be null");
        Currency = currency;
    }
