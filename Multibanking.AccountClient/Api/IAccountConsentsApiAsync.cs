...
public interface IAccountConsentsApiAsync : IApiAccessor
{
    ...
    Task<ConsentResponse> CreateAccountAccessConsentsAsync(Consent consent, string xCustomerUserAgent = default, string xFapiAuthDate = default,
    ...
    Task<ApiResponse<ConsentResponse>> CreateAccountAccessConsentsWithHttpInfoAsync(Consent consent, string xCustomerUserAgent = default, string xFapiAuthDate = default,
        string xFapiInteractionId = default, string xFapiCustomerIpAddress = default, string xIdempotencyKey = default, int operationIndex = 0,
        CancellationToken cancellationToken = default);
    ...
    Task DeleteAccountAccessConsentsConsentIdAsync(string consentId, string xFapiAuthDate = default, string xFapiCustomerIpAddress = default, string xFapiInteractionId = default,
    ...
    Task<ApiResponse<object>> DeleteAccountAccessConsentsConsentIdWithHttpInfoAsync(string consentId, string xFapiAuthDate = default, string xFapiCustomerIpAddress = default,
    ...
    /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
    /// <returns>Task of ConsentResponse</returns>
    Task<ConsentResponse> GetAccountAccessConsentsConsentIdAsync(string consentId, string xFapiAuthDate = default, string xFapiCustomerIpAddress = default,
        string xFapiInteractionId = default, string xCustomerUserAgent = default, int operationIndex = 0, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
    /// <returns>Task of ApiResponse (ConsentResponse)</returns>
    Task<ApiResponse<ConsentResponse>> GetAccountAccessConsentsConsentIdWithHttpInfoAsync(string consentId, string xFapiAuthDate = default, string xFapiCustomerIpAddress = default,
        string xFapiInteractionId = default, string xCustomerUserAgent = default, int operationIndex = 0, CancellationToken cancellationToken = default);
    ...
    Task<RetrievalGrantResponse> GetAccountAccessRetrievalGrantAsync(string consentId, string xFapiAuthDate = default, string xFapiCustomerIpAddress = default,
        string xFapiInteractionId = default, string xCustomerUserAgent = default, int operationIndex = 0, CancellationToken cancellationToken = default);
    ...
    Task<ApiResponse<RetrievalGrantResponse>> GetAccountAccessRetrievalGrantWithHttpInfoAsync(string consentId, string xFapiAuthDate = default,
