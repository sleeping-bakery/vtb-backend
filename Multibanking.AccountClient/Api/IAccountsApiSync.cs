...
public interface IAccountsApiSync : IApiAccessor
{
    ...
    AccountResponse GetAccounts(int? page = default, string xFapiAuthDate = default, string xFapiCustomerIpAddress = default, string xFapiInteractionId = default,
    ...
    ApiResponse<AccountResponse> GetAccountsWithHttpInfo(int? page = default, string xFapiAuthDate = default, string xFapiCustomerIpAddress = default,
    ...
    /// <param name="operationIndex">Index associated with the operation.</param>
    /// <returns>AccountResponse</returns>
    AccountResponse GetAccountsaccountId(string accountId, string xFapiAuthDate = default, string xFapiCustomerIpAddress = default, string xFapiInteractionId = default,
        string xCustomerUserAgent = default, int operationIndex = 0);
    ...
    /// <param name="operationIndex">Index associated with the operation.</param>
    /// <returns>ApiResponse of AccountResponse</returns>
    ApiResponse<AccountResponse> GetAccountsaccountIdWithHttpInfo(string accountId, string xFapiAuthDate = default, string xFapiCustomerIpAddress = default,
        string xFapiInteractionId = default, string xCustomerUserAgent = default, int operationIndex = 0);
