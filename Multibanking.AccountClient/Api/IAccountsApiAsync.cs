...
public interface IAccountsApiAsync : IApiAccessor
{
    ...
    Task<AccountResponse> GetAccountsAsync(int? page = default, string xFapiAuthDate = default, string xFapiCustomerIpAddress = default, string xFapiInteractionId = default,
    ...
    Task<ApiResponse<AccountResponse>> GetAccountsWithHttpInfoAsync(int? page = default, string xFapiAuthDate = default, string xFapiCustomerIpAddress = default,
    ...
    /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
    /// <returns>Task of AccountResponse</returns>
    Task<AccountResponse> GetAccountsaccountIdAsync(string accountId, string xFapiAuthDate = default, string xFapiCustomerIpAddress = default, string xFapiInteractionId = default,
        string xCustomerUserAgent = default, int operationIndex = 0, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
    /// <returns>Task of ApiResponse (AccountResponse)</returns>
    Task<ApiResponse<AccountResponse>> GetAccountsaccountIdWithHttpInfoAsync(string accountId, string xFapiAuthDate = default, string xFapiCustomerIpAddress = default,
        string xFapiInteractionId = default, string xCustomerUserAgent = default, int operationIndex = 0, CancellationToken cancellationToken = default);
