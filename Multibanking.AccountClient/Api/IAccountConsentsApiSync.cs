...
public interface IAccountConsentsApiSync : IApiAccessor
{
    ...
    ConsentResponse CreateAccountAccessConsents(Consent consent, string xCustomerUserAgent = default,
    ...
    ApiResponse<ConsentResponse> CreateAccountAccessConsentsWithHttpInfo(Consent consent,
    ...
    /// <param name="operationIndex">Index associated with the operation.</param>
    /// <returns></returns>
    void DeleteAccountAccessConsentsConsentId(string consentId, string xFapiAuthDate = default,
    ...
    ApiResponse<object> DeleteAccountAccessConsentsConsentIdWithHttpInfo(string consentId,
    ...
    /// <param name="operationIndex">Index associated with the operation.</param>
    /// <returns>ConsentResponse</returns>
    ConsentResponse GetAccountAccessConsentsConsentId(string consentId, string xFapiAuthDate = default,
        string xFapiCustomerIpAddress = default, string xFapiInteractionId = default,
        string xCustomerUserAgent = default, int operationIndex = 0);
    ...
    /// <param name="operationIndex">Index associated with the operation.</param>
    /// <returns>ApiResponse of ConsentResponse</returns>
    ApiResponse<ConsentResponse> GetAccountAccessConsentsConsentIdWithHttpInfo(string consentId,
        string xFapiAuthDate = default, string xFapiCustomerIpAddress = default, string xFapiInteractionId = default,
        string xCustomerUserAgent = default, int operationIndex = 0);
    ...
    RetrievalGrantResponse GetAccountAccessRetrievalGrant(string consentId, string xFapiAuthDate = default,
        string xFapiCustomerIpAddress = default, string xFapiInteractionId = default,
        string xCustomerUserAgent = default, int operationIndex = 0);
    ...
    ApiResponse<RetrievalGrantResponse> GetAccountAccessRetrievalGrantWithHttpInfo(string consentId,
        string xFapiAuthDate = default, string xFapiCustomerIpAddress = default, string xFapiInteractionId = default,
        string xCustomerUserAgent = default, int operationIndex = 0);
