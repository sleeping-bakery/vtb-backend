...
public interface IStatementsApiSync : IApiAccessor
{
    ...
    StatementResponse GetAccountsaccountIdStatementsStatementId(string accountId, string statementId,
    ...
    ApiResponse<StatementResponse> GetAccountsaccountIdStatementsStatementIdWithHttpInfo(string accountId,
    ...
    /// <param name="operationIndex">Index associated with the operation.</param>
    /// <returns>StatementResponse</returns>
    StatementResponse GetStatements(int? page = default, DateTime? fromBookingDateTime = default,
        DateTime? toBookingDateTime = default, string xFapiAuthDate = default, string xFapiCustomerIpAddress = default,
        string xFapiInteractionId = default, string xCustomerUserAgent = default, int operationIndex = 0);
    ...
    /// <param name="operationIndex">Index associated with the operation.</param>
    /// <returns>ApiResponse of StatementResponse</returns>
    ApiResponse<StatementResponse> GetStatementsWithHttpInfo(int? page = default,
    ...
    StatementInitResponse GetStatementsaccountId(string accountId, string xIdempotencyKey,
    ...
    ApiResponse<StatementInitResponse> GetStatementsaccountIdWithHttpInfo(string accountId, string xIdempotencyKey,
        StatementInitRequest statementInitRequest, string xCustomerUserAgent = default, string xFapiAuthDate = default,
        string xFapiInteractionId = default, string xFapiCustomerIpAddress = default, int operationIndex = 0);
