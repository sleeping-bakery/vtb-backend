...
public interface IStatementsApiAsync : IApiAccessor
{
    ...
    Task<StatementResponse> GetAccountsaccountIdStatementsStatementIdAsync(string accountId,
    ...
    Task<ApiResponse<StatementResponse>>
    ...
    /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
    /// <returns>Task of StatementResponse</returns>
    Task<StatementResponse> GetStatementsAsync(int? page = default,
    ...
    /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
    /// <returns>Task of ApiResponse (StatementResponse)</returns>
    Task<ApiResponse<StatementResponse>> GetStatementsWithHttpInfoAsync(int? page = default,
        DateTime? fromBookingDateTime = default, DateTime? toBookingDateTime = default, string xFapiAuthDate = default,
        string xFapiCustomerIpAddress = default, string xFapiInteractionId = default,
        string xCustomerUserAgent = default, int operationIndex = 0,
        CancellationToken cancellationToken = default);
    ...
    /// </summary>
    /// <remarks>
    ///     ППУ предоставляет конечную точку СПИУ для получения идентификатора выписки statementId по идентификатору счета
    ///     accountId, который предоставляется при вызове конечной точки GET /accounts
    /// </remarks>
    /// <exception cref="Multibanking.AccountClient.Client.ApiException">Thrown when fails to make API call</exception>
    /// <param name="accountId">Идентификатор счета</param>
    ...
    Task<StatementInitResponse> GetStatementsaccountIdAsync(string accountId,
    ...
    Task<ApiResponse<StatementInitResponse>> GetStatementsaccountIdWithHttpInfoAsync(
        string accountId, string xIdempotencyKey, StatementInitRequest statementInitRequest,
        string xCustomerUserAgent = default, string xFapiAuthDate = default, string xFapiInteractionId = default,
        string xFapiCustomerIpAddress = default, int operationIndex = 0,
        CancellationToken cancellationToken = default);
