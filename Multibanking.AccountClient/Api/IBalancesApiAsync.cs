...
public interface IBalancesApiAsync : IApiAccessor
{
    ...
    Task<BalanceResponse> GetAccountsaccountIdBalancesAsync(string accountId,
    ...
    Task<ApiResponse<BalanceResponse>> GetAccountsaccountIdBalancesWithHttpInfoAsync(
    ...
    /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
    /// <returns>Task of BalanceResponse</returns>
    Task<BalanceResponse> GetBalancesAsync(int? page = default, string xFapiAuthDate = default,
    ...
    /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
    /// <returns>Task of ApiResponse (BalanceResponse)</returns>
    Task<ApiResponse<BalanceResponse>> GetBalancesWithHttpInfoAsync(int? page = default,
        string xFapiAuthDate = default, string xFapiCustomerIpAddress = default, string xFapiInteractionId = default,
        string xCustomerUserAgent = default, int operationIndex = 0,
        CancellationToken cancellationToken = default);
