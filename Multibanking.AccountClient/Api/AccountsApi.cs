...
public class AccountsApi : IAccountsApi
{
    ...
    /// <summary>
    ///     Получение списка счетов СПИУ предоставляется полный список счетов (с идентификаторами accountId), которые были авторизованы пользователем на стороне ППУ.
    /// </summary>
    ...
    public AccountResponse GetAccounts(int? page = default, string xFapiAuthDate = default, string xFapiCustomerIpAddress = default, string xFapiInteractionId = default,
        string xCustomerUserAgent = default, int operationIndex = 0)
    {
        var localVarResponse = GetAccountsWithHttpInfo(page, xFapiAuthDate, xFapiCustomerIpAddress, xFapiInteractionId, xCustomerUserAgent);
    ...
    public ApiResponse<AccountResponse> GetAccountsWithHttpInfo(int? page = default, string xFapiAuthDate = default, string xFapiCustomerIpAddress = default,
    ...
    public async Task<AccountResponse> GetAccountsAsync(int? page = default, string xFapiAuthDate = default, string xFapiCustomerIpAddress = default,
        string xFapiInteractionId = default, string xCustomerUserAgent = default, int operationIndex = 0, CancellationToken cancellationToken = default)
    {
        var localVarResponse =
            await GetAccountsWithHttpInfoAsync(page, xFapiAuthDate, xFapiCustomerIpAddress, xFapiInteractionId, xCustomerUserAgent, operationIndex, cancellationToken)
    ...
    public async Task<ApiResponse<AccountResponse>> GetAccountsWithHttpInfoAsync(int? page = default, string xFapiAuthDate = default, string xFapiCustomerIpAddress = default,
        string xFapiInteractionId = default, string xCustomerUserAgent = default, int operationIndex = 0, CancellationToken cancellationToken = default)
    {
        var localVarRequestOptions = new RequestOptions();
        ...
        // make the HTTP request
        var localVarResponse = await AsynchronousClient.GetAsync<AccountResponse>("/accounts", localVarRequestOptions, Configuration, cancellationToken).ConfigureAwait(false);
    ...
    /// <summary>
    ///     Получение детальной информации о счете СПИУ получает детальную информацию о счете по идентификатору accountId (который был получен при вызове конечной точке списка счетов GET
    ///     /accounts).
    /// </summary>
    /// <exception cref="Multibanking.AccountClient.Client.ApiException">Thrown when fails to make API call</exception>
    ...
    /// <param name="operationIndex">Index associated with the operation.</param>
    /// <returns>AccountResponse</returns>
    public AccountResponse GetAccountsaccountId(string accountId, string xFapiAuthDate = default, string xFapiCustomerIpAddress = default, string xFapiInteractionId = default,
        string xCustomerUserAgent = default, int operationIndex = 0)
    {
        var localVarResponse = GetAccountsaccountIdWithHttpInfo(accountId, xFapiAuthDate, xFapiCustomerIpAddress, xFapiInteractionId, xCustomerUserAgent);
        return localVarResponse.Data;
    }
    ...
    /// <param name="operationIndex">Index associated with the operation.</param>
    /// <returns>ApiResponse of AccountResponse</returns>
    public ApiResponse<AccountResponse> GetAccountsaccountIdWithHttpInfo(string accountId, string xFapiAuthDate = default, string xFapiCustomerIpAddress = default,
        string xFapiInteractionId = default, string xCustomerUserAgent = default, int operationIndex = 0)
    {
        // verify the required parameter 'accountId' is set
        if (accountId == null) throw new ApiException(400, "Missing required parameter 'accountId' when calling AccountsApi->GetAccountsaccountId");
        ...
        // make the HTTP request
        var localVarResponse = Client.Get<AccountResponse>("/accounts/{accountId}", localVarRequestOptions, Configuration);
        if (ExceptionFactory != null)
        {
    ...
    /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
    /// <returns>Task of AccountResponse</returns>
    public async Task<AccountResponse> GetAccountsaccountIdAsync(string accountId, string xFapiAuthDate = default, string xFapiCustomerIpAddress = default,
        string xFapiInteractionId = default, string xCustomerUserAgent = default, int operationIndex = 0, CancellationToken cancellationToken = default)
    {
        var localVarResponse =
            await GetAccountsaccountIdWithHttpInfoAsync(accountId, xFapiAuthDate, xFapiCustomerIpAddress, xFapiInteractionId, xCustomerUserAgent, operationIndex, cancellationToken)
                .ConfigureAwait(false);
        return localVarResponse.Data;
    }
    ...
    /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
    /// <returns>Task of ApiResponse (AccountResponse)</returns>
    public async Task<ApiResponse<AccountResponse>> GetAccountsaccountIdWithHttpInfoAsync(string accountId, string xFapiAuthDate = default, string xFapiCustomerIpAddress = default,
        string xFapiInteractionId = default, string xCustomerUserAgent = default, int operationIndex = 0, CancellationToken cancellationToken = default)
    {
        // verify the required parameter 'accountId' is set
        if (accountId == null) throw new ApiException(400, "Missing required parameter 'accountId' when calling AccountsApi->GetAccountsaccountId");
        ...
        // make the HTTP request
        var localVarResponse = await AsynchronousClient.GetAsync<AccountResponse>("/accounts/{accountId}", localVarRequestOptions, Configuration, cancellationToken)
            .ConfigureAwait(false);
