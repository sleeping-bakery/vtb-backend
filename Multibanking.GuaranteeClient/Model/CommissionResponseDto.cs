...
namespace Multibanking.GuaranteeClient.Model
{
    ...
    public class CommissionResponseDto : IEquatable<CommissionResponseDto>, IValidatableObject
    {
        /// <summary>
        ...
        public CommissionResponseDto(decimal commissionAmount = default)
        {
        ...
        public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            if (CommissionAmount < 0)
                yield return new ValidationResult("Invalid value for CommissionAmount, must be a value greater than or equal to 0.", new[] { "CommissionAmount" });
        }
        ...
        {
            return Equals(input as CommissionResponseDto);
        }
