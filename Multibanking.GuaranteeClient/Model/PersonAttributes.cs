...
namespace Multibanking.GuaranteeClient.Model
{
    ...
    public partial class PersonAttributes : IEquatable<PersonAttributes>, IValidatableObject
    {
        /// <summary>
        ...
        public PersonAttributes(List<GuaranteeAddress> addresses = default(List<GuaranteeAddress>), CitizenshipEnum citizenship = default(CitizenshipEnum), string inn = default(string), string snils = default(string))
        {
            // to ensure "addresses" is required (not null)
            if (addresses == null)
            {
                throw new ArgumentNullException("addresses is a required property for PersonAttributes and cannot be null");
            }
        ...
        {
            return this.Equals(input as PersonAttributes);
        }
        ...
        public bool Equals(PersonAttributes input)
        {
            ...
            return 
                ...
                (
                    this.Snils == input.Snils ||
                    (this.Snils != null &&
                    this.Snils.Equals(input.Snils))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Snils != null)
                {
                    hashCode = (hashCode * 59) + this.Snils.GetHashCode();
                }
                return hashCode;
            }
        }
        ...
        public IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            if (this.Snils != null && this.Snils.Length > 50)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Snils, length must be less than 50.", new [] { "Snils" });
            }

            // Snils (string) minLength
            if (this.Snils != null && this.Snils.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Snils, length must be greater than 1.", new [] { "Snils" });
            }
