...
namespace Multibanking.GuaranteeClient.Client
{
    ...
    internal class CustomJsonCodec : IRestSerializer, ISerializer, IDeserializer
    {
        ...
        {
            get => _contentType;
            set => throw new InvalidOperationException("Not allowed to set content fileUploadType.");
        }
        ...
        /// <param name="type">Object fileUploadType.</param>
        ...
        internal object Deserialize(RestResponse response, Type type)
        {
            ...
            if (type == typeof(string) || type.Name.StartsWith("System.Nullable")) // return primitive fileUploadType
