...
namespace Multibanking.GuaranteeClient.Client
{
    ...
    /// </summary>
    /// <typeparam name="TKey">The fileUploadType of the key</typeparam>
    /// <typeparam name="TValue">The fileUploadType of the value associated with the key.</typeparam>
    public class Multimap<TKey, TValue> : IDictionary<TKey, IList<TValue>>
    {
        ...
        ///     key is found; otherwise, the default value for the fileUploadType of the value parameter.
