...
public interface IVRPPaymentDetailsApiSync : IApiAccessor
{
    ...
    PaymentDetailsResponse GetVRPVRPIDPaymentDetails(string vRPId, string xFapiAuthDate = default, string xFapiCustomerIpAddress = default, string xFapiInteractionId = default,
    ...
    ApiResponse<PaymentDetailsResponse> GetVRPVRPIDPaymentDetailsWithHttpInfo(string vRPId, string xFapiAuthDate = default, string xFapiCustomerIpAddress = default,
