...
/// </summary>
[DataContract(Name = "VRPRequest_Data_Instruction")]
public class VRPRequestDataInstruction : IEquatable<VRPRequestDataInstruction>, IValidatableObject
{
    /// <summary>
    ///     Initializes a new instance of the <see cref="VRPRequestDataInstruction" /> class.
    /// </summary>
    [JsonConstructorAttribute]
    protected VRPRequestDataInstruction()
    {
    }
    ...
    public VRPRequestDataInstruction(string instructionIdentification = default, string endToEndIdentification = default, PurposeCode? purpose = default,
        ...
        VRPInstructionRemittanceInformation remittanceInformation = default)
    {
        ...
        if (instructionIdentification == null) throw new ArgumentNullException("instructionIdentification is a required property for VRPRequestDataInstruction and cannot be null");
        InstructionIdentification = instructionIdentification;
        // to ensure "endToEndIdentification" is required (not null)
        if (endToEndIdentification == null) throw new ArgumentNullException("endToEndIdentification is a required property for VRPRequestDataInstruction and cannot be null");
        EndToEndIdentification = endToEndIdentification;
        // to ensure "instructedAmount" is required (not null)
        if (instructedAmount == null) throw new ArgumentNullException("instructedAmount is a required property for VRPRequestDataInstruction and cannot be null");
    ...
    /// <summary>
    ///     Returns true if VRPRequestDataInstruction instances are equal
    /// </summary>
    /// <param name="input">Instance of VRPRequestDataInstruction to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(VRPRequestDataInstruction input)
    {
    ...
    public override string ToString()
    {
        ...
        sb.Append("class VRPRequestDataInstruction {\n");
    ...
    {
        return Equals(input as VRPRequestDataInstruction);
    }
