...
namespace Multibanking.PeriodPaymentClient.Model
{
    ...
    public partial class VRPRequestDataInstruction : IEquatable<VRPRequestDataInstruction>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as VRPRequestDataInstruction);
        }
