...
{
    /// <summary>
    /// Информация, предоставляемая для обеспечения квитовки с позициями, которые должен обеспечить перевод, например, коммерческий счет коммерческие счета, по которым ведется учет в системе ожидаемых поступлений.
    /// </summary>
    [DataContract(Name = "VRPInstruction_RemittanceInformation")]
    public partial class VRPInstructionRemittanceInformation : IEquatable<VRPInstructionRemittanceInformation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VRPInstructionRemittanceInformation" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected VRPInstructionRemittanceInformation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="VRPInstructionRemittanceInformation" /> class.
        /// </summary>
        ...
        public VRPInstructionRemittanceInformation(string unstructured = default(string), RemittanceInformationCreditorReferenceInformation creditorReferenceInformation = default(RemittanceInformationCreditorReferenceInformation), RemittanceInformationTaxRemittance taxRemittance = default(RemittanceInformationTaxRemittance))
        {
            // to ensure "unstructured" is required (not null)
            if (unstructured == null)
            {
                throw new ArgumentNullException("unstructured is a required property for VRPInstructionRemittanceInformation and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class VRPInstructionRemittanceInformation {\n");
        ...
        {
            return this.Equals(input as VRPInstructionRemittanceInformation);
        }

        /// <summary>
        /// Returns true if VRPInstructionRemittanceInformation instances are equal
        /// </summary>
        /// <param name="input">Instance of VRPInstructionRemittanceInformation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VRPInstructionRemittanceInformation input)
        {
            if (input == null)
            {
                return false;
