...
public class VRPInstructionRemittanceInformation : IEquatable<VRPInstructionRemittanceInformation>, IValidatableObject
{
    /// <summary>
    ...
    public VRPInstructionRemittanceInformation(string unstructured = default, RemittanceInformationCreditorReferenceInformation creditorReferenceInformation = default,
        RemittanceInformationTaxRemittance taxRemittance = default)
    {
        // to ensure "unstructured" is required (not null)
        if (unstructured == null) throw new ArgumentNullException("unstructured is a required property for VRPInstructionRemittanceInformation and cannot be null");
    ...
    {
        return Equals(input as VRPInstructionRemittanceInformation);
    }
