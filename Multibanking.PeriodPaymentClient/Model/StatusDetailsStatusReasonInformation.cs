...
public class StatusDetailsStatusReasonInformation : IEquatable<StatusDetailsStatusReasonInformation>, IValidatableObject
{
    /// <summary>
    ...
    public StatusDetailsStatusReasonInformation(StatusReasonCode? reason = default, string additionalInformation = default)
    {
        Reason = reason;
    ...
    {
        return Equals(input as StatusDetailsStatusReasonInformation);
    }
