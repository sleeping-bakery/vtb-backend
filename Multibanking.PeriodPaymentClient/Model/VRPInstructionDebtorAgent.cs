...
public class VRPInstructionDebtorAgent : IEquatable<VRPInstructionDebtorAgent>, IValidatableObject
{
    /// <summary>
    ...
    public VRPInstructionDebtorAgent(FinancialInstitutionIdentificationCode schemeName = default, string identification = default)
    {
        SchemeName = schemeName;
        // to ensure "identification" is required (not null)
        if (identification == null) throw new ArgumentNullException("identification is a required property for VRPInstructionDebtorAgent and cannot be null");
    ...
    {
        return Equals(input as VRPInstructionDebtorAgent);
    }
