...
namespace Multibanking.PeriodPaymentClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BranchAndFinancialInstitutionIdentification")]
    public partial class BranchAndFinancialInstitutionIdentification : IEquatable<BranchAndFinancialInstitutionIdentification>, IValidatableObject
    {
        ...
        public BranchAndFinancialInstitutionIdentification(FinancialInstitutionIdentificationCode schemeName = default(FinancialInstitutionIdentificationCode), string identification = default(string))
        {
            this.SchemeName = schemeName;
            // to ensure "identification" is required (not null)
            if (identification == null)
            {
                throw new ArgumentNullException("identification is a required property for BranchAndFinancialInstitutionIdentification and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BranchAndFinancialInstitutionIdentification {\n");
        ...
        {
            return this.Equals(input as BranchAndFinancialInstitutionIdentification);
        }

        /// <summary>
        /// Returns true if BranchAndFinancialInstitutionIdentification instances are equal
        /// </summary>
        /// <param name="input">Instance of BranchAndFinancialInstitutionIdentification to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BranchAndFinancialInstitutionIdentification input)
        {
            if (input == null)
            {
                return false;
