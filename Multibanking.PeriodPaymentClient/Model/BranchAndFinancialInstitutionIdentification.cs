...
public class BranchAndFinancialInstitutionIdentification : IEquatable<BranchAndFinancialInstitutionIdentification>, IValidatableObject
{
    /// <summary>
    ...
    public BranchAndFinancialInstitutionIdentification(FinancialInstitutionIdentificationCode schemeName = default, string identification = default)
    {
        SchemeName = schemeName;
        // to ensure "identification" is required (not null)
        if (identification == null) throw new ArgumentNullException("identification is a required property for BranchAndFinancialInstitutionIdentification and cannot be null");
    ...
    {
        return Equals(input as BranchAndFinancialInstitutionIdentification);
    }
