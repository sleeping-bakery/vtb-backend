...
namespace Multibanking.PeriodPaymentClient.Model
{
    ...
    public partial class VRPInitiationRemittanceInformation : IEquatable<VRPInitiationRemittanceInformation>, IValidatableObject
    {
        /// <summary>
        ...
        public VRPInitiationRemittanceInformation(string unstructured = default(string), RemittanceInformationCreditorReferenceInformation creditorReferenceInformation = default(RemittanceInformationCreditorReferenceInformation), RemittanceInformationTaxRemittance taxRemittance = default(RemittanceInformationTaxRemittance))
        {
            // to ensure "unstructured" is required (not null)
            if (unstructured == null)
            {
                throw new ArgumentNullException("unstructured is a required property for VRPInitiationRemittanceInformation and cannot be null");
            }
        ...
        {
            return this.Equals(input as VRPInitiationRemittanceInformation);
        }
