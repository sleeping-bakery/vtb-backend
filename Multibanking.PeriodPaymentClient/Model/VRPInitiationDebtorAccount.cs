...
{
    /// <summary>
    /// Уникальная идентификация счета плательщика, на котором будет сделана дебетовая запись в результате платежной операции
    /// </summary>
    [DataContract(Name = "VRPInitiation_DebtorAccount")]
    public partial class VRPInitiationDebtorAccount : IEquatable<VRPInitiationDebtorAccount>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="VRPInitiationDebtorAccount" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected VRPInitiationDebtorAccount() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="VRPInitiationDebtorAccount" /> class.
        /// </summary>
        ...
        public VRPInitiationDebtorAccount(string name = default(string), AccountIdentificationCode schemeName = default(AccountIdentificationCode), string identification = default(string))
        {
            this.SchemeName = schemeName;
            // to ensure "identification" is required (not null)
            if (identification == null)
            {
                throw new ArgumentNullException("identification is a required property for VRPInitiationDebtorAccount and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class VRPInitiationDebtorAccount {\n");
        ...
        {
            return this.Equals(input as VRPInitiationDebtorAccount);
        }

        /// <summary>
        /// Returns true if VRPInitiationDebtorAccount instances are equal
        /// </summary>
        /// <param name="input">Instance of VRPInitiationDebtorAccount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VRPInitiationDebtorAccount input)
        {
            if (input == null)
            {
                return false;
