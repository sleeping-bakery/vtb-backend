...
public class VRPInitiationDebtorAccount : IEquatable<VRPInitiationDebtorAccount>, IValidatableObject
{
    /// <summary>
    ...
    ///     (required).
    /// </param>
    public VRPInitiationDebtorAccount(string name = default, AccountIdentificationCode schemeName = default, string identification = default)
    {
        SchemeName = schemeName;
        // to ensure "identification" is required (not null)
        if (identification == null) throw new ArgumentNullException("identification is a required property for VRPInitiationDebtorAccount and cannot be null");
    ...
    {
        return Equals(input as VRPInitiationDebtorAccount);
    }
