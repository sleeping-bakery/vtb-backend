...
namespace Multibanking.PeriodPaymentClient.Model
{
    ...
    public partial class VRPResponseDataChargesInner : IEquatable<VRPResponseDataChargesInner>, IValidatableObject
    {
        ...
        public VRPResponseDataChargesInner(ChargeBearerTypeCode? chargeBearer = default(ChargeBearerTypeCode?), ChargeAmount amount = default(ChargeAmount))
        {
        ...
        {
            return this.Equals(input as VRPResponseDataChargesInner);
        }
