...
namespace Multibanking.PeriodPaymentClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "VRPInstruction_DebtorAgentAccount")]
    public partial class VRPInstructionDebtorAgentAccount : IEquatable<VRPInstructionDebtorAgentAccount>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="VRPInstructionDebtorAgentAccount" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected VRPInstructionDebtorAgentAccount() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="VRPInstructionDebtorAgentAccount" /> class.
        /// </summary>
        ...
        public VRPInstructionDebtorAgentAccount(string name = default(string), AccountIdentificationCode schemeName = default(AccountIdentificationCode), string identification = default(string))
        {
            this.SchemeName = schemeName;
            // to ensure "identification" is required (not null)
            if (identification == null)
            {
                throw new ArgumentNullException("identification is a required property for VRPInstructionDebtorAgentAccount and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class VRPInstructionDebtorAgentAccount {\n");
        ...
        {
            return this.Equals(input as VRPInstructionDebtorAgentAccount);
        }

        /// <summary>
        /// Returns true if VRPInstructionDebtorAgentAccount instances are equal
        /// </summary>
        /// <param name="input">Instance of VRPInstructionDebtorAgentAccount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VRPInstructionDebtorAgentAccount input)
        {
            if (input == null)
            {
                return false;
