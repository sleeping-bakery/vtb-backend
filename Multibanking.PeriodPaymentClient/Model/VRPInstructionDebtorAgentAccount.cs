...
public class VRPInstructionDebtorAgentAccount : IEquatable<VRPInstructionDebtorAgentAccount>, IValidatableObject
{
    /// <summary>
    ...
    ///     (required).
    /// </param>
    public VRPInstructionDebtorAgentAccount(string name = default, AccountIdentificationCode schemeName = default, string identification = default)
    {
        SchemeName = schemeName;
        // to ensure "identification" is required (not null)
        if (identification == null) throw new ArgumentNullException("identification is a required property for VRPInstructionDebtorAgentAccount and cannot be null");
    ...
    {
        return Equals(input as VRPInstructionDebtorAgentAccount);
    }
