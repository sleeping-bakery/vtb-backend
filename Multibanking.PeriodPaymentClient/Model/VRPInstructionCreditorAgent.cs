...
public class VRPInstructionCreditorAgent : IEquatable<VRPInstructionCreditorAgent>, IValidatableObject
{
    /// <summary>
    ...
    public VRPInstructionCreditorAgent(FinancialInstitutionIdentificationCode schemeName = default, string identification = default)
    {
        SchemeName = schemeName;
        // to ensure "identification" is required (not null)
        if (identification == null) throw new ArgumentNullException("identification is a required property for VRPInstructionCreditorAgent and cannot be null");
    ...
    {
        return Equals(input as VRPInstructionCreditorAgent);
    }
