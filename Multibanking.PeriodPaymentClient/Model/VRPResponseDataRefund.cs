...
{
    /// <summary>
    /// Счет для возврата средств Плательщику
    /// </summary>
    [DataContract(Name = "VRPResponse_Data_Refund")]
    public partial class VRPResponseDataRefund : IEquatable<VRPResponseDataRefund>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="VRPResponseDataRefund" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected VRPResponseDataRefund() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="VRPResponseDataRefund" /> class.
        /// </summary>
        ...
        public VRPResponseDataRefund(string name = default(string), AccountIdentificationCode schemeName = default(AccountIdentificationCode), string identification = default(string))
        {
            this.SchemeName = schemeName;
            // to ensure "identification" is required (not null)
            if (identification == null)
            {
                throw new ArgumentNullException("identification is a required property for VRPResponseDataRefund and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class VRPResponseDataRefund {\n");
        ...
        {
            return this.Equals(input as VRPResponseDataRefund);
        }

        /// <summary>
        /// Returns true if VRPResponseDataRefund instances are equal
        /// </summary>
        /// <param name="input">Instance of VRPResponseDataRefund to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VRPResponseDataRefund input)
        {
            if (input == null)
            {
                return false;
