...
public class VRPResponseDataRefund : IEquatable<VRPResponseDataRefund>, IValidatableObject
{
    /// <summary>
    ...
    ///     (required).
    /// </param>
    public VRPResponseDataRefund(string name = default, AccountIdentificationCode schemeName = default, string identification = default)
    {
        SchemeName = schemeName;
        // to ensure "identification" is required (not null)
        if (identification == null) throw new ArgumentNullException("identification is a required property for VRPResponseDataRefund and cannot be null");
    ...
    {
        return Equals(input as VRPResponseDataRefund);
    }
