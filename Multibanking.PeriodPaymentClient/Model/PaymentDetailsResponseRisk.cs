...
public class PaymentDetailsResponseRisk : IEquatable<PaymentDetailsResponseRisk>, IValidatableObject
{
    /// <summary>
    ...
    public PaymentDetailsResponseRisk(PaymentContextCode? paymentContextCode = default, string merchantCategoryCode = default, string merchantCustomerIdentification = default,
    ...
    {
        return Equals(input as PaymentDetailsResponseRisk);
    }
