...
public class PartyIdentification : IEquatable<PartyIdentification>, IValidatableObject
{
    ...
    public PartyIdentification(string name = default, string mobileNumber = default, string countryOfResidence = default, string countryOfBirth = default,
        ...
        PartyIdentificationPostalAddress postalAddress = default)
    {
        ...
        if (name == null) throw new ArgumentNullException("name is a required property for PartyIdentification and cannot be null");
        Name = name;
