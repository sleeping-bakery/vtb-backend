...
namespace Multibanking.PeriodPaymentClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PaymentTypeInformation")]
    public partial class PaymentTypeInformation : IEquatable<PaymentTypeInformation>, IValidatableObject
    {
        ...
        public PaymentTypeInformation(LocalInstrumentCode? localInstrument = default(LocalInstrumentCode?), CBRFCategoryPurpose1? categoryPurpose = default(CBRFCategoryPurpose1?), ServiceLevelCode? serviceLevel = default(ServiceLevelCode?))
        {
        ...
        {
            return this.Equals(input as PaymentTypeInformation);
        }

        /// <summary>
        /// Returns true if PaymentTypeInformation instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentTypeInformation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentTypeInformation input)
        {
            if (input == null)
            {
                return false;
