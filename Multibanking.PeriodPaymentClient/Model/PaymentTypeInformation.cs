...
public class PaymentTypeInformation : IEquatable<PaymentTypeInformation>, IValidatableObject
{
    /// <summary>
    ...
    public PaymentTypeInformation(LocalInstrumentCode? localInstrument = default, CBRFCategoryPurpose1? categoryPurpose = default, ServiceLevelCode? serviceLevel = default)
    {
    ...
    {
        return Equals(input as PaymentTypeInformation);
    }
