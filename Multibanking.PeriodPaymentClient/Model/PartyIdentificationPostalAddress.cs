...
public class PartyIdentificationPostalAddress : IEquatable<PartyIdentificationPostalAddress>, IValidatableObject
{
    /// <summary>
    ...
    public PartyIdentificationPostalAddress(AddressTypeCode? addressType = default, List<string> addressLine = default, string streetName = default,
    ...
    {
        return Equals(input as PartyIdentificationPostalAddress);
    }
