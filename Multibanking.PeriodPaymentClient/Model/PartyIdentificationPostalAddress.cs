...
namespace Multibanking.PeriodPaymentClient.Model
{
    ...
    /// Почтовый адрес
    /// </summary>
    [DataContract(Name = "PartyIdentification_PostalAddress")]
    public partial class PartyIdentificationPostalAddress : IEquatable<PartyIdentificationPostalAddress>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PartyIdentificationPostalAddress" /> class.
        /// </summary>
        ...
        public PartyIdentificationPostalAddress(AddressTypeCode? addressType = default(AddressTypeCode?), List<string> addressLine = default(List<string>), string streetName = default(string), string buildingNumber = default(string), string postCode = default(string), string townName = default(string), string countrySubDivision = default(string), string country = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PartyIdentificationPostalAddress {\n");
        ...
        {
            return this.Equals(input as PartyIdentificationPostalAddress);
        }

        /// <summary>
        /// Returns true if PartyIdentificationPostalAddress instances are equal
        /// </summary>
        /// <param name="input">Instance of PartyIdentificationPostalAddress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PartyIdentificationPostalAddress input)
        {
            if (input == null)
            {
                return false;
