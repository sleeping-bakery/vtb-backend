...
namespace Multibanking.PeriodPaymentClient.Model
{
    ...
    public partial class VRPResponse : IEquatable<VRPResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public VRPResponse(VRPResponseData data = default(VRPResponseData), VRPConsentRequestRisk risk = default(VRPConsentRequestRisk), VRPConsentResponseLinks links = default(VRPConsentResponseLinks), VRPConsentResponseMeta meta = default(VRPConsentResponseMeta))
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for VRPResponse and cannot be null");
            }
            this.Data = data;
            // to ensure "risk" is required (not null)
            if (risk == null)
            {
                throw new ArgumentNullException("risk is a required property for VRPResponse and cannot be null");
            }
            this.Risk = risk;
            // to ensure "links" is required (not null)
            if (links == null)
            {
                throw new ArgumentNullException("links is a required property for VRPResponse and cannot be null");
            }
            this.Links = links;
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new ArgumentNullException("meta is a required property for VRPResponse and cannot be null");
            }
            this.Meta = meta;
        }
        ...
        {
            return this.Equals(input as VRPResponse);
        }
