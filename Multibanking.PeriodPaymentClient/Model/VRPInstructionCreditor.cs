...
namespace Multibanking.PeriodPaymentClient.Model
{
    ...
    public partial class VRPInstructionCreditor : IEquatable<VRPInstructionCreditor>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as VRPInstructionCreditor);
        }
