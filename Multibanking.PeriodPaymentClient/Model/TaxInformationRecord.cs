...
namespace Multibanking.PeriodPaymentClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TaxInformation_Record")]
    public partial class TaxInformationRecord : IEquatable<TaxInformationRecord>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TaxInformationRecord" /> class.
        /// </summary>
        ...
        public TaxInformationRecord(string type = default(string), string category = default(string), string categoryDetails = default(string), string debtorStatus = default(string), List<TaxRecordPeriodInner> period = default(List<TaxRecordPeriodInner>), TaxRecordTaxAmount taxAmount = default(TaxRecordTaxAmount))
        {
            this.Type = type;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TaxInformationRecord {\n");
        ...
        {
            return this.Equals(input as TaxInformationRecord);
        }

        /// <summary>
        /// Returns true if TaxInformationRecord instances are equal
        /// </summary>
        /// <param name="input">Instance of TaxInformationRecord to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TaxInformationRecord input)
        {
            if (input == null)
            {
                return false;
