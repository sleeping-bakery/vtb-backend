...
public class TaxInformationRecord : IEquatable<TaxInformationRecord>, IValidatableObject
{
    /// <summary>
    ...
    public TaxInformationRecord(string type = default, string category = default, string categoryDetails = default, string debtorStatus = default,
        List<TaxRecordPeriodInner> period = default, TaxRecordTaxAmount taxAmount = default)
    {
        Type = type;
        Category = category;
    ...
    {
        return Equals(input as TaxInformationRecord);
    }
