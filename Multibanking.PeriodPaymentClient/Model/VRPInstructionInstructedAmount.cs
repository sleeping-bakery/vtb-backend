...
namespace Multibanking.PeriodPaymentClient.Model
{
    ...
    public partial class VRPInstructionInstructedAmount : IEquatable<VRPInstructionInstructedAmount>, IValidatableObject
    {
        /// <summary>
        ...
        public VRPInstructionInstructedAmount(string amount = default(string), string currency = default(string))
        {
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new ArgumentNullException("amount is a required property for VRPInstructionInstructedAmount and cannot be null");
            }
            this.Amount = amount;
            // to ensure "currency" is required (not null)
            if (currency == null)
            {
                throw new ArgumentNullException("currency is a required property for VRPInstructionInstructedAmount and cannot be null");
            }
        ...
        {
            return this.Equals(input as VRPInstructionInstructedAmount);
        }
