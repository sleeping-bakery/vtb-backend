...
public class TaxInformationCreditor : IEquatable<TaxInformationCreditor>, IValidatableObject
{
    /// <summary>
    ...
    public TaxInformationCreditor(string taxType = default, string registrationIdentification = default)
    {
        TaxType = taxType;
    ...
    {
        return Equals(input as TaxInformationCreditor);
    }
