...
public class VRPInstructionUltimateCreditor : IEquatable<VRPInstructionUltimateCreditor>, IValidatableObject
{
    /// <summary>
    ...
    public VRPInstructionUltimateCreditor(string name = default, string mobileNumber = default, string countryOfResidence = default, string countryOfBirth = default,
        ...
        PartyIdentificationPostalAddress postalAddress = default)
    {
        ...
        if (name == null) throw new ArgumentNullException("name is a required property for VRPInstructionUltimateCreditor and cannot be null");
        Name = name;
        // to ensure "identification" is required (not null)
        if (identification == null) throw new ArgumentNullException("identification is a required property for VRPInstructionUltimateCreditor and cannot be null");
    ...
    {
        return Equals(input as VRPInstructionUltimateCreditor);
    }
