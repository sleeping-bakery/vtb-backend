...
namespace Multibanking.PeriodPaymentClient.Model
{
    ...
    public partial class VRPInstructionUltimateDebtor : IEquatable<VRPInstructionUltimateDebtor>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as VRPInstructionUltimateDebtor);
        }
