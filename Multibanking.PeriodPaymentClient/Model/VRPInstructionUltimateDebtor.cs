...
/// </summary>
[DataContract(Name = "VRPInstruction_UltimateDebtor")]
public class VRPInstructionUltimateDebtor : IEquatable<VRPInstructionUltimateDebtor>, IValidatableObject
{
    /// <summary>
    ///     Initializes a new instance of the <see cref="VRPInstructionUltimateDebtor" /> class.
    /// </summary>
    [JsonConstructorAttribute]
    protected VRPInstructionUltimateDebtor()
    {
    }
    ...
    public VRPInstructionUltimateDebtor(string name = default, string mobileNumber = default, string countryOfResidence = default, string countryOfBirth = default,
        ...
        PartyIdentificationPostalAddress postalAddress = default)
    {
        ...
        if (name == null) throw new ArgumentNullException("name is a required property for VRPInstructionUltimateDebtor and cannot be null");
        Name = name;
        // to ensure "identification" is required (not null)
        if (identification == null) throw new ArgumentNullException("identification is a required property for VRPInstructionUltimateDebtor and cannot be null");
    ...
    /// <summary>
    ///     Returns true if VRPInstructionUltimateDebtor instances are equal
    /// </summary>
    /// <param name="input">Instance of VRPInstructionUltimateDebtor to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(VRPInstructionUltimateDebtor input)
    {
    ...
    public override string ToString()
    {
        ...
        sb.Append("class VRPInstructionUltimateDebtor {\n");
    ...
    {
        return Equals(input as VRPInstructionUltimateDebtor);
    }
