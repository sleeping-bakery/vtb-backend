...
public class Risk : IEquatable<Risk>, IValidatableObject
{
    /// <summary>
    ...
    public Risk(PaymentContextCode? paymentContextCode = default, string merchantCategoryCode = default, string merchantCustomerIdentification = default,
