...
{
    /// <summary>
    /// Объект Risk отправляется инициатором платежа в ППИУ, используется для указания дополнительных деталей для оценки рисков при проведении платежей
    /// </summary>
    [DataContract(Name = "Risk")]
    public partial class Risk : IEquatable<Risk>, IValidatableObject
    {
        ...
        public Risk(PaymentContextCode? paymentContextCode = default(PaymentContextCode?), string merchantCategoryCode = default(string), string merchantCustomerIdentification = default(string), List<RiskDeliveryAddressInner> deliveryAddress = default(List<RiskDeliveryAddressInner>))
        {
