...
namespace Multibanking.PeriodPaymentClient.Model
{
    ...
    public partial class PAFundsAvailableResult1 : IEquatable<PAFundsAvailableResult1>, IValidatableObject
    {
        /// <summary>
        /// Результат доступности, четко указывающий на наличие средств на сумму, указанную в запросе
        /// </summary>
        ...
        public PAFundsAvailableResult1(DateTime fundsAvailableDateTime = default(DateTime), FundsAvailableEnum fundsAvailable = default(FundsAvailableEnum))
        {
        ...
        {
            return this.Equals(input as PAFundsAvailableResult1);
        }
