...
public class OBRUError : IEquatable<OBRUError>, IValidatableObject
{
    ...
    public OBRUError(string errorCode = default, string message = default, string path = default, string url = default)
    {
        // to ensure "errorCode" is required (not null)
        if (errorCode == null) throw new ArgumentNullException("errorCode is a required property for OBRUError and cannot be null");
        ErrorCode = errorCode;
