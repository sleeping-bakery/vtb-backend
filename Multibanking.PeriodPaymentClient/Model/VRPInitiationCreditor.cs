...
///     Получатель средств
/// </summary>
[DataContract(Name = "VRPInitiation_Creditor")]
public class VRPInitiationCreditor : IEquatable<VRPInitiationCreditor>, IValidatableObject
{
    /// <summary>
    ///     Initializes a new instance of the <see cref="VRPInitiationCreditor" /> class.
    /// </summary>
    [JsonConstructorAttribute]
    protected VRPInitiationCreditor()
    {
    }
    ...
    public VRPInitiationCreditor(string name = default, string mobileNumber = default, string countryOfResidence = default, string countryOfBirth = default,
        ...
        PartyIdentificationPostalAddress postalAddress = default)
    {
        ...
        if (name == null) throw new ArgumentNullException("name is a required property for VRPInitiationCreditor and cannot be null");
        Name = name;
        // to ensure "identification" is required (not null)
        if (identification == null) throw new ArgumentNullException("identification is a required property for VRPInitiationCreditor and cannot be null");
    ...
    /// <summary>
    ///     Returns true if VRPInitiationCreditor instances are equal
    /// </summary>
    /// <param name="input">Instance of VRPInitiationCreditor to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(VRPInitiationCreditor input)
    {
    ...
    public override string ToString()
    {
        ...
        sb.Append("class VRPInitiationCreditor {\n");
    ...
    {
        return Equals(input as VRPInitiationCreditor);
    }
