...
namespace Multibanking.PeriodPaymentClient.Model
{
    ...
    public partial class VRPInitiationCreditor : IEquatable<VRPInitiationCreditor>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as VRPInitiationCreditor);
        }
