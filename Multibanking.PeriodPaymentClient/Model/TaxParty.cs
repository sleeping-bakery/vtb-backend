...
namespace Multibanking.PeriodPaymentClient.Model
{
    ...
    public partial class TaxParty : IEquatable<TaxParty>, IValidatableObject
    {
        /// <summary>
        ...
        public TaxParty(string taxType = default(string), string registrationIdentification = default(string))
        {
        ...
        {
            return this.Equals(input as TaxParty);
        }
