...
public class StatusDetails : IEquatable<StatusDetails>, IValidatableObject
{
    /// <summary>
    ...
    public StatusDetails(string paymentTransactionId = default, PaymentTransactionStatusCode transactionStatus = default, DateTime statusUpdateDateTime = default,
        StatusDetailsStatusReasonInformation statusReasonInformation = default)
    {
        // to ensure "paymentTransactionId" is required (not null)
        if (paymentTransactionId == null) throw new ArgumentNullException("paymentTransactionId is a required property for StatusDetails and cannot be null");
    ...
    {
        return Equals(input as StatusDetails);
    }
