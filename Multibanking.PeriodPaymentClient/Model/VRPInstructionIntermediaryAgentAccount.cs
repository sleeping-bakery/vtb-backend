...
namespace Multibanking.PeriodPaymentClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "VRPInstruction_IntermediaryAgentAccount")]
    public partial class VRPInstructionIntermediaryAgentAccount : IEquatable<VRPInstructionIntermediaryAgentAccount>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="VRPInstructionIntermediaryAgentAccount" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected VRPInstructionIntermediaryAgentAccount() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="VRPInstructionIntermediaryAgentAccount" /> class.
        /// </summary>
        ...
        public VRPInstructionIntermediaryAgentAccount(string name = default(string), AccountIdentificationCode schemeName = default(AccountIdentificationCode), string identification = default(string))
        {
            this.SchemeName = schemeName;
            // to ensure "identification" is required (not null)
            if (identification == null)
            {
                throw new ArgumentNullException("identification is a required property for VRPInstructionIntermediaryAgentAccount and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class VRPInstructionIntermediaryAgentAccount {\n");
        ...
        {
            return this.Equals(input as VRPInstructionIntermediaryAgentAccount);
        }

        /// <summary>
        /// Returns true if VRPInstructionIntermediaryAgentAccount instances are equal
        /// </summary>
        /// <param name="input">Instance of VRPInstructionIntermediaryAgentAccount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VRPInstructionIntermediaryAgentAccount input)
        {
            if (input == null)
            {
                return false;
