...
public class VRPInstructionIntermediaryAgentAccount : IEquatable<VRPInstructionIntermediaryAgentAccount>, IValidatableObject
{
    /// <summary>
    ...
    ///     (required).
    /// </param>
    public VRPInstructionIntermediaryAgentAccount(string name = default, AccountIdentificationCode schemeName = default, string identification = default)
    {
        SchemeName = schemeName;
        // to ensure "identification" is required (not null)
        if (identification == null) throw new ArgumentNullException("identification is a required property for VRPInstructionIntermediaryAgentAccount and cannot be null");
    ...
    {
        return Equals(input as VRPInstructionIntermediaryAgentAccount);
    }
