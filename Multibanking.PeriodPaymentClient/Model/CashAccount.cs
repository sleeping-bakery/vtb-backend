...
namespace Multibanking.PeriodPaymentClient.Model
{
    ...
    /// Идентификация счета
    /// </summary>
    [DataContract(Name = "CashAccount")]
    public partial class CashAccount : IEquatable<CashAccount>, IValidatableObject
    {
        ...
        public CashAccount(string name = default(string), AccountIdentificationCode schemeName = default(AccountIdentificationCode), string identification = default(string))
        {
            this.SchemeName = schemeName;
            // to ensure "identification" is required (not null)
            if (identification == null)
            {
                throw new ArgumentNullException("identification is a required property for CashAccount and cannot be null");
            }
        ...
        {
            return this.Equals(input as CashAccount);
        }

        /// <summary>
        /// Returns true if CashAccount instances are equal
        /// </summary>
        /// <param name="input">Instance of CashAccount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CashAccount input)
        {
            if (input == null)
            {
                return false;
