...
public class CashAccount : IEquatable<CashAccount>, IValidatableObject
{
    /// <summary>
    ...
    ///     (required).
    /// </param>
    public CashAccount(string name = default, AccountIdentificationCode schemeName = default, string identification = default)
    {
        SchemeName = schemeName;
        // to ensure "identification" is required (not null)
        if (identification == null) throw new ArgumentNullException("identification is a required property for CashAccount and cannot be null");
    ...
    {
        return Equals(input as CashAccount);
    }
