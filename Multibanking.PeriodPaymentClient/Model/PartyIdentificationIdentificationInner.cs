...
namespace Multibanking.PeriodPaymentClient.Model
{
    ...
    public partial class PartyIdentificationIdentificationInner : IEquatable<PartyIdentificationIdentificationInner>, IValidatableObject
    {
        ...
        public PartyIdentificationIdentificationInner(PeriodPaymentPartyIdentificationCode schemeName = default(PeriodPaymentPartyIdentificationCode), string identification = default(string))
        {
            this.SchemeName = schemeName;
            // to ensure "identification" is required (not null)
            if (identification == null)
            {
                throw new ArgumentNullException("identification is a required property for PartyIdentificationIdentificationInner and cannot be null");
            }
        ...
        {
            return this.Equals(input as PartyIdentificationIdentificationInner);
        }
