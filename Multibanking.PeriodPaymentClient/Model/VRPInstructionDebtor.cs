...
///     Плательщик
/// </summary>
[DataContract(Name = "VRPInstruction_Debtor")]
public class VRPInstructionDebtor : IEquatable<VRPInstructionDebtor>, IValidatableObject
{
    /// <summary>
    ///     Initializes a new instance of the <see cref="VRPInstructionDebtor" /> class.
    /// </summary>
    [JsonConstructorAttribute]
    protected VRPInstructionDebtor()
    {
    }
    ...
    public VRPInstructionDebtor(string name = default, string mobileNumber = default, string countryOfResidence = default, string countryOfBirth = default,
        ...
        PartyIdentificationPostalAddress postalAddress = default)
    {
        ...
        if (name == null) throw new ArgumentNullException("name is a required property for VRPInstructionDebtor and cannot be null");
        Name = name;
        // to ensure "identification" is required (not null)
        if (identification == null) throw new ArgumentNullException("identification is a required property for VRPInstructionDebtor and cannot be null");
    ...
    /// <summary>
    ///     Returns true if VRPInstructionDebtor instances are equal
    /// </summary>
    /// <param name="input">Instance of VRPInstructionDebtor to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(VRPInstructionDebtor input)
    {
    ...
    public override string ToString()
    {
        ...
        sb.Append("class VRPInstructionDebtor {\n");
    ...
    {
        return Equals(input as VRPInstructionDebtor);
    }
