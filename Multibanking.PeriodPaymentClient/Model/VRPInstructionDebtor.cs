...
namespace Multibanking.PeriodPaymentClient.Model
{
    ...
    public partial class VRPInstructionDebtor : IEquatable<VRPInstructionDebtor>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as VRPInstructionDebtor);
        }
