...
namespace Multibanking.PeriodPaymentClient.Model
{
    ...
    public partial class VRPInitiationCreditorAgent : IEquatable<VRPInitiationCreditorAgent>, IValidatableObject
    {
        ...
        public VRPInitiationCreditorAgent(FinancialInstitutionIdentificationCode schemeName = default(FinancialInstitutionIdentificationCode), string identification = default(string))
        {
            this.SchemeName = schemeName;
            // to ensure "identification" is required (not null)
            if (identification == null)
            {
                throw new ArgumentNullException("identification is a required property for VRPInitiationCreditorAgent and cannot be null");
            }
        ...
        {
            return this.Equals(input as VRPInitiationCreditorAgent);
        }
