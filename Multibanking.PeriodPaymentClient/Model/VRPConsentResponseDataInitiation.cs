...
namespace Multibanking.PeriodPaymentClient.Model
{
    ...
    public partial class VRPConsentResponseDataInitiation : IEquatable<VRPConsentResponseDataInitiation>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as VRPConsentResponseDataInitiation);
        }
