...
public class TaxInformationDebtor : IEquatable<TaxInformationDebtor>, IValidatableObject
{
    /// <summary>
    ...
    public TaxInformationDebtor(string taxType = default, string registrationIdentification = default)
    {
        TaxType = taxType;
    ...
    {
        return Equals(input as TaxInformationDebtor);
    }
