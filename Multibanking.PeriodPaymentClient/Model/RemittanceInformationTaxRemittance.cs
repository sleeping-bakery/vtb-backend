...
/// </summary>
[DataContract(Name = "RemittanceInformation_TaxRemittance")]
public class RemittanceInformationTaxRemittance : IEquatable<RemittanceInformationTaxRemittance>, IValidatableObject
{
    /// <summary>
    ///     Initializes a new instance of the <see cref="RemittanceInformationTaxRemittance" /> class.
    /// </summary>
    ...
    public RemittanceInformationTaxRemittance(string administrationZone = default, string referenceNumber = default, DateTime date = default,
        TaxInformationCreditor creditor = default, TaxInformationDebtor debtor = default, TaxInformationRecord record = default)
    {
    ...
    /// <summary>
    ///     Returns true if RemittanceInformationTaxRemittance instances are equal
    /// </summary>
    /// <param name="input">Instance of RemittanceInformationTaxRemittance to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(RemittanceInformationTaxRemittance input)
    {
    ...
    public override string ToString()
    {
        ...
        sb.Append("class RemittanceInformationTaxRemittance {\n");
    ...
    {
        return Equals(input as RemittanceInformationTaxRemittance);
    }
