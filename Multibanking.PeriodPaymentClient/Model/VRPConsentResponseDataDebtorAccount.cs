...
public class VRPConsentResponseDataDebtorAccount : IEquatable<VRPConsentResponseDataDebtorAccount>, IValidatableObject
{
    /// <summary>
    ...
    ///     (required).
    /// </param>
    public VRPConsentResponseDataDebtorAccount(string name = default, AccountIdentificationCode schemeName = default, string identification = default)
    {
        SchemeName = schemeName;
        // to ensure "identification" is required (not null)
        if (identification == null) throw new ArgumentNullException("identification is a required property for VRPConsentResponseDataDebtorAccount and cannot be null");
    ...
    {
        return Equals(input as VRPConsentResponseDataDebtorAccount);
    }
