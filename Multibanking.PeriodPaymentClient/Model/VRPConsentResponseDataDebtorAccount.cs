...
{
    /// <summary>
    /// Однозначная идентификация счета плательщика, который будет использоваться при  переводе денежных средств
    /// </summary>
    [DataContract(Name = "VRPConsentResponse_Data_DebtorAccount")]
    public partial class VRPConsentResponseDataDebtorAccount : IEquatable<VRPConsentResponseDataDebtorAccount>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="VRPConsentResponseDataDebtorAccount" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected VRPConsentResponseDataDebtorAccount() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="VRPConsentResponseDataDebtorAccount" /> class.
        /// </summary>
        ...
        public VRPConsentResponseDataDebtorAccount(string name = default(string), AccountIdentificationCode schemeName = default(AccountIdentificationCode), string identification = default(string))
        {
            this.SchemeName = schemeName;
            // to ensure "identification" is required (not null)
            if (identification == null)
            {
                throw new ArgumentNullException("identification is a required property for VRPConsentResponseDataDebtorAccount and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class VRPConsentResponseDataDebtorAccount {\n");
        ...
        {
            return this.Equals(input as VRPConsentResponseDataDebtorAccount);
        }

        /// <summary>
        /// Returns true if VRPConsentResponseDataDebtorAccount instances are equal
        /// </summary>
        /// <param name="input">Instance of VRPConsentResponseDataDebtorAccount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VRPConsentResponseDataDebtorAccount input)
        {
            if (input == null)
            {
                return false;
