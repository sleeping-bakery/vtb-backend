...
public class Links : IEquatable<Links>, IValidatableObject
{
    /// <summary>
    ...
    public Links(string self = default, string first = default, string prev = default, string next = default, string last = default)
    {
        // to ensure "self" is required (not null)
        if (self == null) throw new ArgumentNullException("self is a required property for Links and cannot be null");
        Self = self;
        First = first;
        Prev = prev;
        Next = next;
