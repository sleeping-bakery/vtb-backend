...
public class ServiceSubError : IEquatable<ServiceSubError>, IValidatableObject
{
    /// <summary>
    ///     Статус ошибки
    /// </summary>
    ...
    public enum TypeEnum
    {
        ...
        /// </summary>
        [EnumMember(Value = "ProviderError")] ProviderError = 2
    }
    ...
    public ServiceSubError(string field = default, string message = default, string _object = default, object rejectedValue = default, object response = default,
        StatusEnum? status = default, TypeEnum type = default)
    {
        Type = type;
        Field = field;
        Message = message;
    ...
    public bool Equals(ServiceSubError input)
    {
        ...
        return
            ...
            (
                ...
                (RejectedValue != null &&
                 RejectedValue.Equals(input.RejectedValue))
            ) &&
            (
    ...
    public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
    {
        ...
        if (Field != null && Field.Length > 100) yield return new ValidationResult("Invalid value for Field, length must be less than 100.", new[] { "Field" });

        // Message (string) maxLength
        if (Message != null && Message.Length > 5000) yield return new ValidationResult("Invalid value for Message, length must be less than 5000.", new[] { "Message" });

        // Object (string) maxLength
        if (Object != null && Object.Length > 100) yield return new ValidationResult("Invalid value for Object, length must be less than 100.", new[] { "Object" });
    }
    ...
    {
        return Equals(input as ServiceSubError);
    }
    ...
    public override int GetHashCode()
    {
        ...
        {
            var hashCode = 41;
            if (Field != null) hashCode = hashCode * 59 + Field.GetHashCode();
            if (Message != null) hashCode = hashCode * 59 + Message.GetHashCode();
            if (Object != null) hashCode = hashCode * 59 + Object.GetHashCode();
            if (RejectedValue != null) hashCode = hashCode * 59 + RejectedValue.GetHashCode();
            if (Response != null) hashCode = hashCode * 59 + Response.GetHashCode();
