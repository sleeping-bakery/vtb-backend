...
public class UpdateCloseCard400Response : AbstractOpenAPISchema, IEquatable<UpdateCloseCard400Response>, IValidatableObject
{
    ...
    public static UpdateCloseCard400Response FromJson(string jsonString)
    {
        ...
        if (string.IsNullOrEmpty(jsonString)) return newUpdateCloseCard400Response;
        var match = 0;
        ...
        try
        {
            ...
            if (typeof(ServiceError).GetProperty("AdditionalProperties") == null)
                newUpdateCloseCard400Response = new UpdateCloseCard400Response(JsonConvert.DeserializeObject<ServiceError>(jsonString, SerializerSettings));
            else
                newUpdateCloseCard400Response = new UpdateCloseCard400Response(JsonConvert.DeserializeObject<ServiceError>(jsonString, AdditionalPropertiesSerializerSettings));
        ...
        try
        {
            ...
            if (typeof(TykErrorResponse).GetProperty("AdditionalProperties") == null)
                newUpdateCloseCard400Response = new UpdateCloseCard400Response(JsonConvert.DeserializeObject<TykErrorResponse>(jsonString, SerializerSettings));
            else
                newUpdateCloseCard400Response = new UpdateCloseCard400Response(JsonConvert.DeserializeObject<TykErrorResponse>(jsonString, AdditionalPropertiesSerializerSettings));
    ...
    {
        return Equals(input as UpdateCloseCard400Response);
    }
