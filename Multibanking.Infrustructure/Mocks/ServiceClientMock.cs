    ...
    public static Mock<IServiceClient> MockServiceClient()
    {
        ...
        mock.Setup(serviceClient => serviceClient.FindOperations(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(),
            ...
            .Returns(() => new PageDtoRsServiceProviderSearchDtoRs([
                new ServiceProviderSearchDtoRs(Guid.NewGuid().ToString(), Guid.NewGuid().ToString(), Guid.NewGuid().ToString(), ServiceProviderSearchDtoRs.TypeEnum.CONTRACT,
                ...
                new ServiceProviderSearchDtoRs(Guid.NewGuid().ToString(), Guid.NewGuid().ToString(), Guid.NewGuid().ToString(), ServiceProviderSearchDtoRs.TypeEnum.GISHCS,
