...
public class PageDtoRsServiceProviderDetailDtoRs : IEquatable<PageDtoRsServiceProviderDetailDtoRs>, IValidatableObject
{
    /// <summary>
    ...
    public PageDtoRsServiceProviderDetailDtoRs(List<ServiceProviderDetailDtoRs> items = default, int pageNumber = default, int pageSize = default, long total = default,
        bool hasMore = default)
    {
        // to ensure "items" is required (not null)
        if (items == null) throw new ArgumentNullException("items is a required property for PageDtoRsServiceProviderDetailDtoRs and cannot be null");
        Items = items;
    ...
    {
        return Equals(input as PageDtoRsServiceProviderDetailDtoRs);
    }
