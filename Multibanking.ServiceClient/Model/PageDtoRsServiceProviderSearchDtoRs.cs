...
namespace Multibanking.ServiceClient.Model
{
    ...
    public partial class PageDtoRsServiceProviderSearchDtoRs : IEquatable<PageDtoRsServiceProviderSearchDtoRs>, IValidatableObject
    {
        /// <summary>
        ...
        public PageDtoRsServiceProviderSearchDtoRs(List<ServiceProviderSearchDtoRs> items = default(List<ServiceProviderSearchDtoRs>), int pageNumber = default(int), int pageSize = default(int), long total = default(long), bool hasMore = default(bool))
        {
            // to ensure "items" is required (not null)
            if (items == null)
            {
                throw new ArgumentNullException("items is a required property for PageDtoRsServiceProviderSearchDtoRs and cannot be null");
            }
            this.Items = items;
        ...
        {
            return this.Equals(input as PageDtoRsServiceProviderSearchDtoRs);
        }
