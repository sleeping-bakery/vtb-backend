...
public class PageDtoRsCategoryDtoRs : IEquatable<PageDtoRsCategoryDtoRs>, IValidatableObject
{
    /// <summary>
    ...
    public PageDtoRsCategoryDtoRs(List<CategoryDtoRs> items = default, int pageNumber = default, int pageSize = default, long total = default, bool hasMore = default)
    {
        // to ensure "items" is required (not null)
        if (items == null) throw new ArgumentNullException("items is a required property for PageDtoRsCategoryDtoRs and cannot be null");
        Items = items;
    ...
    {
        return Equals(input as PageDtoRsCategoryDtoRs);
    }
