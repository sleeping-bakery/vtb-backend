...
namespace Multibanking.ServiceClient.Model
{
    ...
    public partial class CategoryDtoRs : IEquatable<CategoryDtoRs>, IValidatableObject
    {
        /// <summary>
        ...
        public CategoryDtoRs(string id = default(string), string name = default(string), string nameKey = default(string), List<ServiceProviderSearchDtoRs> serviceProviders = default(List<ServiceProviderSearchDtoRs>))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for CategoryDtoRs and cannot be null");
            }
            this.Id = id;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for CategoryDtoRs and cannot be null");
            }
            this.Name = name;
        ...
        {
            return this.Equals(input as CategoryDtoRs);
        }
        ...
        public bool Equals(CategoryDtoRs input)
        {
            ...
            return 
                ...
                (
                    ...
                    (this.NameKey != null &&
                    this.NameKey.Equals(input.NameKey))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.NameKey.GetHashCode();
                }
        ...
        public IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Id, length must be less than 16.", new [] { "Id" });
            }
            ...
            if (this.NameKey != null && this.NameKey.Length > 64)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for NameKey, length must be less than 64.", new [] { "NameKey" });
            }
