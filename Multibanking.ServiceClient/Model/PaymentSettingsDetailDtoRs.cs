...
namespace Multibanking.ServiceClient.Model
{
    ...
    public partial class PaymentSettingsDetailDtoRs : IEquatable<PaymentSettingsDetailDtoRs>, IValidatableObject
    {
        /// <summary>
        ...
        public enum ClientRolePayRestrictionsEnum
        {
            ...
            /// </summary>
            [EnumMember(Value = "ANONYM_CLIENT")]
            ANONYMCLIENT = 1,

            /// <summary>
            /// Enum UPRIDCLIENT for value: UPRID_CLIENT
            /// </summary>
            [EnumMember(Value = "UPRID_CLIENT")]
            UPRIDCLIENT = 2
        ...
        public PaymentSettingsDetailDtoRs(string acceptanceKey = default(string), List<ClientRolePayRestrictionsEnum> clientRolePayRestrictions = default(List<ClientRolePayRestrictionsEnum>))
        {
            this.AcceptanceKey = acceptanceKey;
            this.ClientRolePayRestrictions = clientRolePayRestrictions;
        }
        ...
        {
            return this.Equals(input as PaymentSettingsDetailDtoRs);
        }
        ...
        public bool Equals(PaymentSettingsDetailDtoRs input)
        {
            ...
            return 
                ...
                (
                    this.ClientRolePayRestrictions == input.ClientRolePayRestrictions ||
                    this.ClientRolePayRestrictions.SequenceEqual(input.ClientRolePayRestrictions)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.ClientRolePayRestrictions.GetHashCode();
                return hashCode;
            }
        }
