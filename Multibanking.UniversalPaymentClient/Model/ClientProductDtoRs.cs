...
namespace Multibanking.UniversalPaymentClient.Model
{
    ...
    public partial class ClientProductDtoRs : IEquatable<ClientProductDtoRs>, IValidatableObject
    {
        /// <summary>
        ...
        public ClientProductDtoRs(AccountDtoRs account = default(AccountDtoRs), CardDtoRs card = default(CardDtoRs))
        {
        ...
        {
            return this.Equals(input as ClientProductDtoRs);
        }
