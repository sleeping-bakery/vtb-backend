...
namespace Multibanking.UniversalPaymentClient.Model
{
    ...
    public partial class ClientConfirmCodeDtoRq : IEquatable<ClientConfirmCodeDtoRq>, IValidatableObject
    {
        /// <summary>
        ...
        public ClientConfirmCodeDtoRq(string code = default(string))
        {
            // to ensure "code" is required (not null)
            if (code == null)
            {
                throw new ArgumentNullException("code is a required property for ClientConfirmCodeDtoRq and cannot be null");
            }
            this.Code = code;
        }
        ...
        {
            return this.Equals(input as ClientConfirmCodeDtoRq);
        }
        ...
        public IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            if (this.Code != null && this.Code.Length > 36)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Code, length must be less than 36.", new [] { "Code" });
            }
