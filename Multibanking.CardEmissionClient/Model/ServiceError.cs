...
public class ServiceError : IEquatable<ServiceError>, IValidatableObject
{
    /// <summary>
    ///     Статус ошибки
    /// </summary>
    ...
    public enum StatusEnum
    {
        ...
        /// </summary>
        [EnumMember(Value = "100 CONTINUE")] _100CONTINUE = 1,
        ...
        /// </summary>
        [EnumMember(Value = "102 PROCESSING")] _102PROCESSING = 3,

        /// <summary>
        ///     Enum _103CHECKPOINT for value: 103 CHECKPOINT
        /// </summary>
        [EnumMember(Value = "103 CHECKPOINT")] _103CHECKPOINT = 4,

        /// <summary>
        ///     Enum _200OK for value: 200 OK
        /// </summary>
        [EnumMember(Value = "200 OK")] _200OK = 5,

        /// <summary>
        ///     Enum _201CREATED for value: 201 CREATED
        /// </summary>
        [EnumMember(Value = "201 CREATED")] _201CREATED = 6,

        /// <summary>
        ///     Enum _202ACCEPTED for value: 202 ACCEPTED
        /// </summary>
        [EnumMember(Value = "202 ACCEPTED")] _202ACCEPTED = 7,
        ...
        /// </summary>
        [EnumMember(Value = "204 NO_CONTENT")] _204NOCONTENT = 9,
        ...
        /// </summary>
        [EnumMember(Value = "226 IM_USED")] _226IMUSED = 14,
        ...
        /// </summary>
        [EnumMember(Value = "302 FOUND")] _302FOUND = 17,
        ...
        /// </summary>
        [EnumMember(Value = "303 SEE_OTHER")] _303SEEOTHER = 19,
        ...
        /// </summary>
        [EnumMember(Value = "305 USE_PROXY")] _305USEPROXY = 21,
        ...
        /// </summary>
        [EnumMember(Value = "403 FORBIDDEN")] _403FORBIDDEN = 27,

        /// <summary>
        ///     Enum _404NOTFOUND for value: 404 NOT_FOUND
        /// </summary>
        [EnumMember(Value = "404 NOT_FOUND")] _404NOTFOUND = 28,
        ...
        /// </summary>
        [EnumMember(Value = "409 CONFLICT")] _409CONFLICT = 33,

        /// <summary>
        ///     Enum _410GONE for value: 410 GONE
        /// </summary>
        [EnumMember(Value = "410 GONE")] _410GONE = 34,
        ...
        /// </summary>
        [EnumMember(Value = "423 LOCKED")] _423LOCKED = 49,
        ...
        /// </summary>
        [EnumMember(Value = "425 TOO_EARLY")] _425TOOEARLY = 51,
    ...
    public ServiceError(string debugMessage = default, string message = default, StatusEnum status = default, List<ServiceSubError> subErrors = default,
    ...
    public bool Equals(ServiceError input)
    {
        ...
        return
            (
                ...
                (DebugMessage != null &&
                 DebugMessage.Equals(input.DebugMessage))
            ) &&
            (
            ...
            (
                SubErrors == input.SubErrors ||
                (SubErrors != null &&
                 input.SubErrors != null &&
                 SubErrors.SequenceEqual(input.SubErrors))
            ) &&
            (
    ...
    public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
    {
        ...
        if (DebugMessage != null && DebugMessage.Length > 5000)
            yield return new ValidationResult("Invalid value for DebugMessage, length must be less than 5000.", new[] { "DebugMessage" });
        ...
        if (Timestamp.ToString(CultureInfo.InvariantCulture).Length > 50)
            yield return new ValidationResult("Invalid value for Timestamp, length must be less than 50.", new[] { "Timestamp" });

        // Timestamp (DateTime) pattern
        var regexTimestamp = new Regex(@"([0-9]{1,4}-[0-9]{1,2}-[0-9]{1,2}[A-Z][0-9]{1,2}:[0-9]{1,2}:[0-9]{1,2}.[0-9]{1,3}[A-Z])", RegexOptions.CultureInvariant);
        if (false == regexTimestamp.Match(Timestamp.ToString(CultureInfo.InvariantCulture)).Success)
            yield return new ValidationResult("Invalid value for Timestamp, must match a pattern of " + regexTimestamp, new[] { "Timestamp" });
    }
    ...
    public override int GetHashCode()
    {
        ...
        {
            var hashCode = 41;
            if (DebugMessage != null) hashCode = hashCode * 59 + DebugMessage.GetHashCode();
            if (Message != null) hashCode = hashCode * 59 + Message.GetHashCode();
            hashCode = hashCode * 59 + Status.GetHashCode();
            if (SubErrors != null) hashCode = hashCode * 59 + SubErrors.GetHashCode();
            if (Timestamp != null) hashCode = hashCode * 59 + Timestamp.GetHashCode();
            return hashCode;
        }
    }
}