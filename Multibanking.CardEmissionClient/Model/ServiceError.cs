...
namespace Multibanking.CardEmissionClient.Model
{
    ...
    public partial class ServiceError : IEquatable<ServiceError>, IValidatableObject
    {
        ...
        public IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            if (this.Timestamp.ToString(CultureInfo.InvariantCulture).Length > 50)
            {
            ...
            if (false == regexTimestamp.Match(this.Timestamp.ToString(CultureInfo.InvariantCulture)).Success)
            {
