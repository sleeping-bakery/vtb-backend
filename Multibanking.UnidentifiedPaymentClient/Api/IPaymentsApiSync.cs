...
public interface IPaymentsApiSync : IApiAccessor
{
    ...
    PaymentResponseComplexType CreatePayment(string xIdempotencyKey, PaymentRequestComplexType paymentRequestComplexType, string xCustomerUserAgent = default,
    ...
    ApiResponse<PaymentResponseComplexType> CreatePaymentWithHttpInfo(string xIdempotencyKey, PaymentRequestComplexType paymentRequestComplexType,
    ...
    ConsentResponseComplexType CreatePaymentConsent(string xIdempotencyKey, ConsentRequestComplexType consentRequestComplexType, string xCustomerUserAgent = default,
        string xFapiAuthDate = default, string xFapiInteractionId = default, string xFapiCustomerIpAddress = default, int operationIndex = 0);
    ...
    ApiResponse<ConsentResponseComplexType> CreatePaymentConsentWithHttpInfo(string xIdempotencyKey, ConsentRequestComplexType consentRequestComplexType,
        string xCustomerUserAgent = default, string xFapiAuthDate = default, string xFapiInteractionId = default, string xFapiCustomerIpAddress = default, int operationIndex = 0);
    ...
    /// <param name="operationIndex">Index associated with the operation.</param>
    /// <returns>PaymentResponseComplexType</returns>
    PaymentResponseComplexType GetPayment(string paymentId, string xFapiAuthDate = default, string xFapiCustomerIpAddress = default, string xFapiInteractionId = default,
    ...
    /// <param name="operationIndex">Index associated with the operation.</param>
    /// <returns>ApiResponse of PaymentResponseComplexType</returns>
    ApiResponse<PaymentResponseComplexType> GetPaymentWithHttpInfo(string paymentId, string xFapiAuthDate = default, string xFapiCustomerIpAddress = default,
    ...
    /// <param name="operationIndex">Index associated with the operation.</param>
    /// <returns>ConsentResponseComplexType</returns>
    ConsentResponseComplexType GetPaymentConsent(string consentId, string xFapiAuthDate = default, string xFapiCustomerIpAddress = default, string xFapiInteractionId = default,
        string xCustomerUserAgent = default, int operationIndex = 0);
    ...
    /// <param name="operationIndex">Index associated with the operation.</param>
    /// <returns>ApiResponse of ConsentResponseComplexType</returns>
    ApiResponse<ConsentResponseComplexType> GetPaymentConsentWithHttpInfo(string consentId, string xFapiAuthDate = default, string xFapiCustomerIpAddress = default,
        string xFapiInteractionId = default, string xCustomerUserAgent = default, int operationIndex = 0);
