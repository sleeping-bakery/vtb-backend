...
namespace Multibanking.UnidentifiedPaymentClient.Model
{
    ...
    public partial class PartyIdentificationCompexTypePostalAddress : IEquatable<PartyIdentificationCompexTypePostalAddress>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as PartyIdentificationCompexTypePostalAddress);
        }
