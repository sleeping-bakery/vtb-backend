...
/// <summary>
///     Информация, которая находит и идентифицирует определенный адрес, как определено почтовыми службами.
/// </summary>
[DataContract(Name = "PartyIdentificationCompexType_PostalAddress")]
public class PartyIdentificationCompexTypePostalAddress : IEquatable<PartyIdentificationCompexTypePostalAddress>, IValidatableObject
{
    /// <summary>
    ///     Initializes a new instance of the <see cref="PartyIdentificationCompexTypePostalAddress" /> class.
    /// </summary>
    ...
    public PartyIdentificationCompexTypePostalAddress(AddressTypeStaticType? addressType = default, string department = default, string subDepartment = default,
    ...
    /// <summary>
    ///     Returns true if PartyIdentificationCompexTypePostalAddress instances are equal
    /// </summary>
    /// <param name="input">Instance of PartyIdentificationCompexTypePostalAddress to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(PartyIdentificationCompexTypePostalAddress input)
    {
    ...
    public override string ToString()
    {
        ...
        sb.Append("class PartyIdentificationCompexTypePostalAddress {\n");
    ...
    {
        return Equals(input as PartyIdentificationCompexTypePostalAddress);
    }
