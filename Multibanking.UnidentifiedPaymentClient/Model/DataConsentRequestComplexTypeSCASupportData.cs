...
namespace Multibanking.UnidentifiedPaymentClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DataConsentRequestComplexType_SCASupportData")]
    public partial class DataConsentRequestComplexTypeSCASupportData : IEquatable<DataConsentRequestComplexTypeSCASupportData>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DataConsentRequestComplexTypeSCASupportData" /> class.
        /// </summary>
        ...
        public DataConsentRequestComplexTypeSCASupportData(SCAExemptionTypeStaticType? requestedSCAExemptionType = default(SCAExemptionTypeStaticType?), AppliedAuthenticationApproachStaticType? appliedAuthenticationApproach = default(AppliedAuthenticationApproachStaticType?), string referencePaymentOrderId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DataConsentRequestComplexTypeSCASupportData {\n");
        ...
        {
            return this.Equals(input as DataConsentRequestComplexTypeSCASupportData);
        }

        /// <summary>
        /// Returns true if DataConsentRequestComplexTypeSCASupportData instances are equal
        /// </summary>
        /// <param name="input">Instance of DataConsentRequestComplexTypeSCASupportData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DataConsentRequestComplexTypeSCASupportData input)
        {
            if (input == null)
            {
                return false;
