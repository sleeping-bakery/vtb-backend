...
public class InitiationComplexTypeCreditorAgent : IEquatable<InitiationComplexTypeCreditorAgent>, IValidatableObject
{
    /// <summary>
    ...
    public InitiationComplexTypeCreditorAgent(FinancialInstitutionIdentificationDynamicType schemeName = default, string identification = default, string name = default,
        PartyIdentificationCompexTypePostalAddress postalAddress = default)
    {
        SchemeName = schemeName;
        // to ensure "identification" is required (not null)
        if (identification == null) throw new ArgumentNullException("identification is a required property for InitiationComplexTypeCreditorAgent and cannot be null");
    ...
    {
        return Equals(input as InitiationComplexTypeCreditorAgent);
    }
