...
namespace Multibanking.UnidentifiedPaymentClient.Model
{
    ...
    public partial class DataPaymentResponseComplexTypeMultiAuthorisation : IEquatable<DataPaymentResponseComplexTypeMultiAuthorisation>, IValidatableObject
    {
        ...
        public DataPaymentResponseComplexTypeMultiAuthorisation(MultiAuthorisationStatusStaticType status = default(MultiAuthorisationStatusStaticType), decimal numberRequired = default(decimal), decimal numberReceived = default(decimal), DateTime lastUpdateDateTime = default(DateTime), DateTime expirationDateTime = default(DateTime))
        {
            this.Status = status;
        ...
        {
            return this.Equals(input as DataPaymentResponseComplexTypeMultiAuthorisation);
        }
