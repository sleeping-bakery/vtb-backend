...
///     платежа.
/// </summary>
[DataContract(Name = "InitiationComplexType")]
public class InitiationComplexType : IEquatable<InitiationComplexType>, IValidatableObject
{
    /// <summary>
    ///     Initializes a new instance of the <see cref="InitiationComplexType" /> class.
    /// </summary>
    [JsonConstructorAttribute]
    protected InitiationComplexType()
    {
    }
    ...
    public InitiationComplexType(string instructionIdentification = default, string endToEndIdentification = default, ExternalLocalInstrument1Code? localInstrument = default,
        InitiationComplexTypeInstructedAmount instructedAmount = default, InitiationComplexTypeDebtorAccount debtorAccount = default,
        InitiationComplexTypeCreditorParty creditorParty = default, InitiationComplexTypeCreditorAgent creditorAgent = default,
        InitiationComplexTypeCreditorAccount creditorAccount = default, InitiationComplexTypeRemittanceInformation remittanceInformation = default)
    {
        // to ensure "instructionIdentification" is required (not null)
        if (instructionIdentification == null) throw new ArgumentNullException("instructionIdentification is a required property for InitiationComplexType and cannot be null");
        InstructionIdentification = instructionIdentification;
        // to ensure "endToEndIdentification" is required (not null)
        if (endToEndIdentification == null) throw new ArgumentNullException("endToEndIdentification is a required property for InitiationComplexType and cannot be null");
        EndToEndIdentification = endToEndIdentification;
        // to ensure "instructedAmount" is required (not null)
        if (instructedAmount == null) throw new ArgumentNullException("instructedAmount is a required property for InitiationComplexType and cannot be null");
        InstructedAmount = instructedAmount;
        // to ensure "creditorAccount" is required (not null)
        if (creditorAccount == null) throw new ArgumentNullException("creditorAccount is a required property for InitiationComplexType and cannot be null");
    ...
    /// <summary>
    ///     Returns true if InitiationComplexType instances are equal
    /// </summary>
    /// <param name="input">Instance of InitiationComplexType to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(InitiationComplexType input)
    {
    ...
    public override string ToString()
    {
        ...
        sb.Append("class InitiationComplexType {\n");
    ...
    {
        return Equals(input as InitiationComplexType);
    }
