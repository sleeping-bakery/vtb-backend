...
namespace Multibanking.UnidentifiedPaymentClient.Model
{
    ...
    public partial class InitiationComplexType : IEquatable<InitiationComplexType>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as InitiationComplexType);
        }
