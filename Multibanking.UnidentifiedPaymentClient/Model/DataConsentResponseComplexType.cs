...
namespace Multibanking.UnidentifiedPaymentClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DataConsentResponseComplexType")]
    public partial class DataConsentResponseComplexType : IEquatable<DataConsentResponseComplexType>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DataConsentResponseComplexType" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DataConsentResponseComplexType() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DataConsentResponseComplexType" /> class.
        /// </summary>
        ...
        public DataConsentResponseComplexType(string consentId = default(string), DateTime creationDateTime = default(DateTime), ConsentStatusStaticType status = default(ConsentStatusStaticType), DateTime statusUpdateDateTime = default(DateTime), DateTime cutOffDateTime = default(DateTime), DateTime expectedExecutionDateTime = default(DateTime), DateTime expectedSettlementDateTime = default(DateTime), List<ChargeComplexType> charges = default(List<ChargeComplexType>), DataConsentRequestComplexTypeInitiation initiation = default(DataConsentRequestComplexTypeInitiation), DataConsentRequestComplexTypeAuthorisation authorisation = default(DataConsentRequestComplexTypeAuthorisation), DataConsentRequestComplexTypeSCASupportData sCASupportData = default(DataConsentRequestComplexTypeSCASupportData))
        {
            ...
            if (initiation == null)
            {
                throw new ArgumentNullException("initiation is a required property for DataConsentResponseComplexType and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DataConsentResponseComplexType {\n");
        ...
        {
            return this.Equals(input as DataConsentResponseComplexType);
        }

        /// <summary>
        /// Returns true if DataConsentResponseComplexType instances are equal
        /// </summary>
        /// <param name="input">Instance of DataConsentResponseComplexType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DataConsentResponseComplexType input)
        {
            if (input == null)
            {
                return false;
