...
public class DataConsentResponseComplexType : IEquatable<DataConsentResponseComplexType>, IValidatableObject
{
    /// <summary>
    ...
    public DataConsentResponseComplexType(string consentId = default, DateTime creationDateTime = default, ConsentStatusStaticType status = default,
        ...
        DataConsentRequestComplexTypeSCASupportData sCASupportData = default)
    {
        ...
        if (consentId == null) throw new ArgumentNullException("consentId is a required property for DataConsentResponseComplexType and cannot be null");
        ConsentId = consentId;
        CreationDateTime = creationDateTime;
        Status = status;
        StatusUpdateDateTime = statusUpdateDateTime;
        // to ensure "initiation" is required (not null)
        if (initiation == null) throw new ArgumentNullException("initiation is a required property for DataConsentResponseComplexType and cannot be null");
    ...
    {
        return Equals(input as DataConsentResponseComplexType);
    }
