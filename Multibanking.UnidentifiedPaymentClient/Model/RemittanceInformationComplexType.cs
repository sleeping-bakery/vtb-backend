...
namespace Multibanking.UnidentifiedPaymentClient.Model
{
    ...
    public partial class RemittanceInformationComplexType : IEquatable<RemittanceInformationComplexType>, IValidatableObject
    {
        /// <summary>
        ...
        public RemittanceInformationComplexType(string unstructured = default(string), string reference = default(string))
        {
        ...
        {
            return this.Equals(input as RemittanceInformationComplexType);
        }
