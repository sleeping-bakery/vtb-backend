...
public class PaymentRequestComplexType : IEquatable<PaymentRequestComplexType>, IValidatableObject
{
    /// <summary>
    ...
    public PaymentRequestComplexType(PaymentRequestComplexTypeData data = default, ConsentRequestComplexTypeRisk risk = default)
    {
        // to ensure "data" is required (not null)
        if (data == null) throw new ArgumentNullException("data is a required property for PaymentRequestComplexType and cannot be null");
        Data = data;
        // to ensure "risk" is required (not null)
        if (risk == null) throw new ArgumentNullException("risk is a required property for PaymentRequestComplexType and cannot be null");
        Risk = risk;
    }
    ...
    {
        return Equals(input as PaymentRequestComplexType);
    }
