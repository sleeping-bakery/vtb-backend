...
public class InitiationComplexTypeCreditorAccount : IEquatable<InitiationComplexTypeCreditorAccount>, IValidatableObject
{
    /// <summary>
    ...
    public InitiationComplexTypeCreditorAccount(PaymentAccountIdentificationDynamicType schemeName = default, string identification = default, string name = default)
    {
        SchemeName = schemeName;
        // to ensure "identification" is required (not null)
        if (identification == null) throw new ArgumentNullException("identification is a required property for InitiationComplexTypeCreditorAccount and cannot be null");
    ...
    {
        return Equals(input as InitiationComplexTypeCreditorAccount);
    }
