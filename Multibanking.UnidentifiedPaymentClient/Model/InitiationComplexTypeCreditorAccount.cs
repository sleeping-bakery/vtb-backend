...
{
    /// <summary>
    /// Идентификатор счета получателя, на котором будет проведена запись о кредите в результате.
    /// </summary>
    [DataContract(Name = "InitiationComplexType_CreditorAccount")]
    public partial class InitiationComplexTypeCreditorAccount : IEquatable<InitiationComplexTypeCreditorAccount>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InitiationComplexTypeCreditorAccount" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InitiationComplexTypeCreditorAccount() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InitiationComplexTypeCreditorAccount" /> class.
        /// </summary>
        ...
        public InitiationComplexTypeCreditorAccount(PaymentAccountIdentificationDynamicType schemeName = default(PaymentAccountIdentificationDynamicType), string identification = default(string), string name = default(string))
        {
            this.SchemeName = schemeName;
            // to ensure "identification" is required (not null)
            if (identification == null)
            {
                throw new ArgumentNullException("identification is a required property for InitiationComplexTypeCreditorAccount and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InitiationComplexTypeCreditorAccount {\n");
        ...
        {
            return this.Equals(input as InitiationComplexTypeCreditorAccount);
        }

        /// <summary>
        /// Returns true if InitiationComplexTypeCreditorAccount instances are equal
        /// </summary>
        /// <param name="input">Instance of InitiationComplexTypeCreditorAccount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InitiationComplexTypeCreditorAccount input)
        {
            if (input == null)
            {
                return false;
