...
namespace Multibanking.UnidentifiedPaymentClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DataConsentRequestComplexType_Authorisation")]
    public partial class DataConsentRequestComplexTypeAuthorisation : IEquatable<DataConsentRequestComplexTypeAuthorisation>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DataConsentRequestComplexTypeAuthorisation" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DataConsentRequestComplexTypeAuthorisation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DataConsentRequestComplexTypeAuthorisation" /> class.
        /// </summary>
        ...
        public DataConsentRequestComplexTypeAuthorisation(AuthorisationStaticType authorisationType = default(AuthorisationStaticType), DateTime completionDateTime = default(DateTime))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DataConsentRequestComplexTypeAuthorisation {\n");
        ...
        {
            return this.Equals(input as DataConsentRequestComplexTypeAuthorisation);
        }

        /// <summary>
        /// Returns true if DataConsentRequestComplexTypeAuthorisation instances are equal
        /// </summary>
        /// <param name="input">Instance of DataConsentRequestComplexTypeAuthorisation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DataConsentRequestComplexTypeAuthorisation input)
        {
            if (input == null)
            {
                return false;
