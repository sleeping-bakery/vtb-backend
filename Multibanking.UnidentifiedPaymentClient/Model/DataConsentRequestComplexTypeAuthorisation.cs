...
public class DataConsentRequestComplexTypeAuthorisation : IEquatable<DataConsentRequestComplexTypeAuthorisation>, IValidatableObject
{
    /// <summary>
    ...
    public DataConsentRequestComplexTypeAuthorisation(AuthorisationStaticType authorisationType = default, DateTime completionDateTime = default)
    {
    ...
    {
        return Equals(input as DataConsentRequestComplexTypeAuthorisation);
    }
