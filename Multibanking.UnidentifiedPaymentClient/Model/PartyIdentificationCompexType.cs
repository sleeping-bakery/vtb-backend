...
namespace Multibanking.UnidentifiedPaymentClient.Model
{
    ...
    public partial class PartyIdentificationCompexType : IEquatable<PartyIdentificationCompexType>, IValidatableObject
    {
        /// <summary>
        ...
        public PartyIdentificationCompexType(string name = default(string), PartyIdentificationCompexTypePostalAddress postalAddress = default(PartyIdentificationCompexTypePostalAddress))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for PartyIdentificationCompexType and cannot be null");
            }
            this.Name = name;
        ...
        {
            return this.Equals(input as PartyIdentificationCompexType);
        }
