...
public class PaymentDetailsComplexTypeStatusDetail : IEquatable<PaymentDetailsComplexTypeStatusDetail>, IValidatableObject
{
    /// <summary>
    ...
    public PaymentDetailsComplexTypeStatusDetail(ExternalPaymentTransactionStatus1Code? localInstrument = default, string status = default,
        TransactionIndividualStatusReasonStaticType? statusReason = default, string statusReasonDescription = default)
    {
        // to ensure "status" is required (not null)
        if (status == null) throw new ArgumentNullException("status is a required property for PaymentDetailsComplexTypeStatusDetail and cannot be null");
        Status = status;
    ...
    {
        return Equals(input as PaymentDetailsComplexTypeStatusDetail);
    }
